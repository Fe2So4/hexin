...
<div ref="FirstAllocation">
  <el-form-item>
    <ui-label-text labelWidth="80" label="费用类别:" text="首年基础服务费">
    </ui-label-text>
  </el-form-item>
  <el-checkbox-group v-model="checklistModel" class="checkgroup checkboxList">
    ...
    <el-checkbox disabled class="checkboxpColor" label="flag12" v-show="firstRate.firstrateData==1">费率</el-checkbox>
  </el-checkbox-group>
  <div style="color: red; margin: 5px 0 20px; " v-show="firstRate.firstrateData==1">注:费率请在手续费率导入中配置</div>
...
<ui-label-text label="首期手续费=首年基础服务费"></ui-label-text>
</div>
</template>
...
export default {
  ...
  watch: {
    ...
    allModel: {
      handler (newValue, oldValue) {
        this.checklistModel = ['flag11', 'flag12']
