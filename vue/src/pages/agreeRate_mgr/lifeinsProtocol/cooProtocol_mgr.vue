<template>
  <div id="insComBusiness_mgr">
    ...
    <div class='btn-container'>
        ...
        <el-button type="primary" :disabled="quanxian.export" @click.native.prevent="exportData">导出</el-button>
    </div>
    <el-table  @selection-change="handleSelectionChange" stripe ref="multipleTable"
     :data="tableData" v-if='isShowTable' tooltip-effect="dark" style="width: 100%">
      ...
      <!-- <el-table-column prop="organizationname" label="合作经代机构名称" ></el-table-column> -->
    ...
    <div v-if="add_dialog">
      ...
      <el-dialog @open="closeFun('baseCoolifeagreementhis')" center
        ...
        <el-form
        :rules="rules" class="mesg_form form_addmod" :model="baseCoolifeagreementhis" ref="baseCoolifeagreementhis">
          <ui-line-tittle :collapsible="true" >
            <span slot="title" >
                <i class="font_family icon-jy-menu-4"></i>{{info.xytitle}}
            </span>
            <div class="ri-content" slot="content">
              <el-row>
                <el-col :span="12">
                  <el-form-item prop="sumtype">
                    <ui-label-text :required="true" labelWidth="160" label="协议类型:">
                        <el-radio-group slot="text" v-model="baseCoolifeagreementhis.sumtype"  @change="changeRadio">
                          <el-radio :disabled="info.title === '合作经代公司寿险协议详情'||(info.title === '合作经代公司寿险协议修改' && orgList.length !== 0 && orgList[0]['verifystatus'] === '审核通过') || userComCode!=='01'" label="1">总公司协议</el-radio>
                          <el-radio :disabled="info.title === '合作经代公司寿险协议详情'||(info.title === '合作经代公司寿险协议修改' && orgList.length !== 0 && orgList[0]['verifystatus'] === '审核通过')" label="2">分公司协议</el-radio>
                        </el-radio-group>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <!-- <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="关联协议代码:">
                      <el-select :disabled="info.title === '合作经代公司寿险协议详情'" @change="getselectModel"
                      v-model="baseCoolifeagreementhis.sumtosum" slot="text" placeholder="请选择">
                        <el-option v-for="(item, index) in sumtosumOption" value-key="index" :key="index" :label="item" :value="index"></el-option>
                      </el-select>
                    </ui-label-text>
                  </el-form-item>
                </el-col> -->
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item prop="companyCode">
                    <ui-label-text :required="true" labelWidth="160" label="合作经代公司代码:">
                      <el-input v-model="baseCoolifeagreementhis.companyCode" slot="text" data-arr="2"
                      :disabled="info.title === '合作经代公司寿险协议详情'"
                      placeholder="双击可选择" clearable  @dblclick.native="dbqueryCom(baseCoolifeagreementhis, '1')"
                      @clear="onClearInput('2', '1')"  @blur="onBlurVerify('2', baseCoolifeagreementhis), '1'"></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="comCode">
                    <ui-label-text :required="true" labelWidth="160" label="佰盈机构代码:">
                      <el-input v-model="baseCoolifeagreementhis.comCode" slot="text" data-arr="1"
                      :disabled="baseCoolifeagreementhis.sumtype === '1' || info.title === '合作经代公司寿险协议详情'"
                      placeholder="双击可选择" clearable @dblclick.native="dbqueryCom(baseCoolifeagreementhis, '1')"
                      @clear="onClearInput('1', '1')" @blur="onBlurVerify('1', baseCoolifeagreementhis), '1'"></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <!-- <el-col :span="12">
                  <el-form-item prop="orgCode">
                    <ui-label-text :required="true" labelWidth="160" label="合作经代公司机构代码:">
                      <el-input v-model="baseCoolifeagreementhis.orgCode" slot="text" data-arr="3"
                      placeholder="双击可选择" clearable @dblclick.native="dbqueryCom(baseCoolifeagreementhis, '1')"
                      @clear="onClearInput('3', '1')"
                      :disabled="baseCoolifeagreementhis.sumtype === '1' || info.title === '合作经代公司寿险协议详情'"
                      @blur="onBlurVerify('3', baseCoolifeagreementhis), '1'"></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col> -->
              </el-row>
              <!-- <el-row>
                <el-col :span="12">
                  <el-form-item prop="orgName">
                    <ui-label-text :required="true" labelWidth="160" label=" 合作经代公司机构名称:">
                      <el-input v-model="baseCoolifeagreementhis.orgName" slot="text" data-arr="33"
                      placeholder="双击可选择" clearable @dblclick.native="dbqueryCom(baseCoolifeagreementhis, '1')"
                      @clear="onClearInput('33', '1')"
                      :disabled="baseCoolifeagreementhis.sumtype === '1' || info.title === '合作经代公司寿险协议详情'"
                      @blur="onBlurVerify('33', baseCoolifeagreementhis), '1'"></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row> -->
                ...
                <el-col :span="12">
                  <el-form-item prop="companyName">
                    <ui-label-text :required="true" labelWidth="160" label="合作经代公司名称:">
                      <el-input v-model="baseCoolifeagreementhis.companyName" slot="text" data-arr="22"
                      :disabled="info.title === '合作经代公司寿险协议详情'"
                      placeholder="双击可选择" clearable @dblclick.native="dbqueryCom(baseCoolifeagreementhis, '1')"
                      @clear="onClearInput('22', '1')" @blur="onBlurVerify('22', baseCoolifeagreementhis), '1'"></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="comCName">
                    <ui-label-text :required="true" labelWidth="160" label="佰盈机构名称:">
                      <el-input v-model="baseCoolifeagreementhis.comCName" slot="text" data-arr="11"
                      :disabled="baseCoolifeagreementhis.sumtype === '1' || info.title === '合作经代公司寿险协议详情'"
                      placeholder="双击可选择" clearable @dblclick.native="dbqueryCom(baseCoolifeagreementhis, '1')"
                      @clear="onClearInput('11', '1')" @blur="onBlurVerify('11', baseCoolifeagreementhis), '1'"></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item prop="agreementname">
                    <ui-label-text :required="true" labelWidth="160" label="协议名称:">
                      <el-select v-model="baseCoolifeagreementhis.agreementname" slot="text"
                      :disabled="info.title === '合作经代公司寿险协议详情'" placeholder="请选择">
                        <el-option label="合作协议" value="1"></el-option>
                        <el-option label="产品补充协议" value="2"></el-option>
                        <el-option label="推动方案" value="3"></el-option>
                      </el-select>
                ...
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="协议代码:">
                      <el-input v-model="baseCoolifeagreementhis.agreementno"
                      :disabled="info.title === '合作经代公司寿险协议详情'" slot="text" readonly></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item prop="agreementtype">
                    <ui-label-text :required="true" labelWidth="160" label="协议分类:">
                      <el-select v-model="baseCoolifeagreementhis.agreementtype" slot="text"
                      :disabled="info.title === '合作经代公司寿险协议详情'" placeholder="请选择">
                        <el-option label="合作协议" value="2"></el-option>
                        <el-option label="补充协议" value="3"></el-option>
                        <el-option label="推动方案" value="4"></el-option>
                        <el-option label="备忘" value="1"></el-option>
                      </el-select>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="startdate">
                    <ui-label-text  :required="true" labelWidth="160" label="协议生效日期:">
                      <el-date-picker :disabled="info.title === '合作经代公司寿险协议详情'"
                      slot="text" v-model="baseCoolifeagreementhis.startdate" type="date" value-format="timestamp" placeholder="选择日期"></el-date-picker>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item prop="jgslyhfa">
                    <ui-label-text  :required="true" labelWidth="160" label="价格税率优惠方案:" >
                      <el-select v-model="baseCoolifeagreementhis.jgslyhfa" slot="text"
                      :disabled="info.title === '合作经代公司寿险协议详情'" placeholder="请选择">
                ...
                <el-col :span="12">
                  <el-form-item prop="enddate">
                    <ui-label-text :required="true" labelWidth="160" label="协议终止日期:" >
                      <el-date-picker :disabled="info.title === '合作经代公司寿险协议详情'"
                      slot="text" v-model="baseCoolifeagreementhis.enddate" value-format="timestamp"
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="是否自动续签:" >
                      <el-select v-model="baseCoolifeagreementhis.renewalflag"
                      :disabled="info.title === '合作经代公司寿险协议详情'" slot="text" placeholder="请选择">
                ...
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="上一年协议号:" >
                      <el-input :disabled="info.title === '合作经代公司寿险协议详情'"
                      v-model="baseCoolifeagreementhis.renewalno" slot="text" ></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="代理许可证编号:" >
                      <el-input :disabled="info.title === '合作经代公司寿险协议详情'"
                      v-model="baseCoolifeagreementhis.permitno"  slot="text" ></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="permitnosdate">
                    <ui-label-text labelWidth="160" label="代理许可证有效起期:" >
                      <el-date-picker :disabled="info.title === '合作经代公司寿险协议详情'" value-format="timestamp"
                      slot="text" v-model="baseCoolifeagreementhis.permitnosdate" type="date" placeholder="选择日期"></el-date-picker>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="代理许可证有效止期:" >
                      <el-date-picker :disabled="info.title === '合作经代公司寿险协议详情'" value-format="timestamp"
                      slot="text" v-model="baseCoolifeagreementhis.permitnoedate"
                      type="date" placeholder="选择日期"></el-date-picker>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="relation">
                    <ui-label-text  :required="true" labelWidth="160" label="关联交易:" >
                      <el-select :disabled="info.title === '合作经代公司寿险协议详情'"
                      v-model="baseCoolifeagreementhis.relation" slot="text" placeholder="请选择">
                        <el-option label="是" value="1"></el-option>
                        <el-option label="否" value="0"></el-option>
                      </el-select>
                    </ui-label-text>
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="支付方式:">
                      <el-select :disabled="info.title === '合作经代公司寿险协议详情'"
                      v-model="baseCoolifeagreementhis.commissionpayment" slot="text" placeholder="请选择">
                ...
                <el-col :span="12">
                  <el-form-item prop="settlecycle">
                    <ui-label-text :required="true" labelWidth="160" label="结算周期（月）:">
                      <el-input :disabled="info.title === '合作经代公司寿险协议详情'" placeholder="请输入1-12"
                      v-model="baseCoolifeagreementhis.settlecycle"  slot="text" ></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item prop="bank">
                    <ui-label-text :required="true" labelWidth="160" label="手续费开户银行:" >
                      <el-input :disabled="info.title === '合作经代公司寿险协议详情'"
                      v-model="baseCoolifeagreementhis.bank"  slot="text" ></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="accountname">
                    <ui-label-text :required="true" labelWidth="160" label="手续费收款账户名:" >
                      <el-input :disabled="info.title === '合作经代公司寿险协议详情'"
                      v-model="baseCoolifeagreementhis.accountname"  slot="text" ></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-form-item prop="account">
                    <ui-label-text :required="true" labelWidth="160" label="手续费收款银行帐号:" >
                      <el-input :disabled="info.title === '合作经代公司寿险协议详情'"
                      v-model="baseCoolifeagreementhis.account"  slot="text" ></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text :required="true" labelWidth="160" label="合作协议/产品补充协议上传：" >
                      <el-button v-if="info.title === '合作经代公司寿险协议详情'" slot="text" @click="showFj(0)">附件管理</el-button>
                      <el-button v-if="info.title === '合作经代公司寿险协议新增'" slot="text" @click="showFj(1)">附件管理</el-button>
                      <el-button v-if="info.title === '合作经代公司寿险协议修改'" slot="text" @click="showFj(2)">附件管理</el-button>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
                ...
                <el-col :span="12">
                  <el-form-item>
                    <ui-label-text labelWidth="160" label="备注:" >
                      <el-input :disabled="info.title === '合作经代公司寿险协议详情'"
                      type="textarea" :rows="1" v-model="baseCoolifeagreementhis.remark"  slot="text" ></el-input>
                    </ui-label-text>
                  </el-form-item>
                </el-col>
              </el-row>
        ...
        <div style="text-align: center; margin-top: 30px;" >
          <el-button
          type='primary' @click.native.prevent="addPut('baseCoolifeagreementhis')"
          v-if="info.title !== '合作经代公司寿险协议详情'"
          >提交审核</el-button>
        </div>
      </el-dialog>
    </div>
    ...
    <!-- 删除提示 -->
    <el-dialog title="提示" center :append-to-body='true' :before-close="delClose" :visible.sync="isDelete" width="30%" >
    ...
    <!-- 审核弹框 -->
    <el-dialog title="协议审核" :append-to-body='true' :before-close="auditClose" center :visible.sync="audit_dialog">
       <ui-line-tittle :collapsible="true" >
         <span slot="title" >
            <i class="font_family icon-jy-menu-4" ></i>协议审核
          </span>
          <div class="ri-content" slot="content">
...
import FirstAllocation from '@/components/firstyearrateAllocation'
import RenewalAllocation from '@/components/renewalrateAllocation'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      picData: [], // 该条记录里的所有附件
      FjfileList: [], // 附件列表
      tempFjfileList: [], // 临时上传文件记录池
      delFlag: true, // 关闭详情弹窗时，是否删除服务器上的临时上传文件记录池中的文件标识
      ...
      userComCode: this.$store.state.login.showComName.split('(')[1].split(')')[0],
      info: {
        agreementno: '',
        agreementname: '',
        title: '合作经代公司寿险协议新增',
        xytitle: '合作经代公司寿险协议新增',
        verifystatus: '0',
        companyCode: '',
        companyName: '',
        orgCode: '',
  ...
  methods: {
    ...
    addPut (formName) { // 提交 校验必填项 rules
      if (IsEmpty(this.picData)) {
        this.open('error', '必须上传许合作协议/产品补充协议')
        return false
      }
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (this.info.title === '合作经代公司寿险协议新增') {
            this.delFlag = false
            this.baseCoolifeagreementhis.agreementno = ''
            api('/baseCooComAgreement/addAgreement', 'post',
              {
            ...
            this.delFlag = false
            api('/baseCooComAgreement/updateAgreement', 'post',
              {
                baseCoolifeagreementhis: this.baseCoolifeagreementhis,
                firstMonthFeecongigModel: this.firstMonthFeecongigModel,
                firstQuarterFeecongigModel: this.firstQuarterFeecongigModel,
    ...
    exportData () {
      let temp = {}
      temp['comcode'] = !IsEmpty(this.info.comCode) ? this.info.comCode : ''
      temp['comcname'] = !IsEmpty(this.info.comCName) ? this.info.comCName : ''
      temp['insurercode'] = !IsEmpty(this.info.companyCode) ? this.info.companyCode : ''
      temp['insurername'] = !IsEmpty(this.info.companyName) ? this.info.companyName : ''
      temp['verifystatus'] = !IsEmpty(this.info.verifystatus) ? this.info.verifystatus : ''
      temp['agreementno'] = !IsEmpty(this.info.agreementno) ? this.info.agreementno : ''
      temp['agreementname'] = !IsEmpty(this.info.agreementname) ? this.info.agreementname : ''
      window.open(`/tabycore/baseCooComAgreement/exportCooagencyAgree?comcode=${temp.comcode}&comcname=${temp.comcname}&insurercode=${temp.insurercode}&insurername=${temp.insurername}&verifystatus=${temp.verifystatus}&agreementno=${temp.agreementno}&agreementname=${temp.agreementname}`)
    },
    ...
    numberforEach (obj) { // 数字转换中文
      obj.forEach(e => {
        e.verifystatus = this.arr2[parseInt(e.verifystatus)] // 审核状态
        e.remark1 = this.arr1[parseInt(e.remark1)] // 审核类型
        e.agreementname = this.arr4[parseInt(e.agreementname)] // 协议名称
      })
    },
    numberforEach2 (obj) { // 修改历史记录 数字转换中文
      obj.forEach(e => {
        e.exaType = this.arr1[parseInt(e.exaType)] // 操作类型
        e.status = this.arr3[parseInt(e.status)] // 审核类型
        e.exaStatus = this.arr2[parseInt(e.exaStatus)] // 审核内容
        e.title = this.arr4[parseInt(e.title)] // 协议名称
      })
    },
    Loading () {
    ...
    searchList () { // 查询
      this.Loading()
      api('/baseCooComAgreement/findByPage', 'post', {
    ...
    deleteTrue () { // 确认删除
      ...
      str = str.join(',')
      api('/baseCooComAgreement/deleteAgreement', 'post', {
        agreementnos: str
      }).then(res => {
        if (res.data.code === '000000') {
          str = []
    ...
    auditPut () { // 确认审核
      ...
      if (this.auditResult.verifyStatus !== undefined) {
        api('/baseCooComAgreement/verifyAgreement', 'post', {
          agreementnos: str,
    ...
    addOrg () { // 新增
      this.info.title = '合作经代公司寿险协议新增'
      this.info.xytitle = '合作经代公司寿险协议新增'
    ...
    modifyDetail () {
      this.info.title = '合作经代公司寿险协议修改'
      this.info.xytitle = '合作经代公司寿险协议修改'
      this.add_dialog = true
    },
    modifyDetail2 () {
      this.info.title = '合作经代公司寿险协议详情'
      this.info.xytitle = '合作经代公司寿险协议详情'
      this.add_dialog = true
    },
    ...
    beforDetail (data) { // 修改前
      Loading.service({text: 'Loading', spinner: 'el-icon-loading', background: 'rgba(0, 0, 0, 0.6)'})
      api('/baseCooComAgreement/findByAgreementno2', 'post', {
        agreementno: data
      }).then(res => {
        this.loadingCLose()
        if (res.data.code === '000000') {
          this.assignmentObj(res.data.data.baseCoolifeagreementhis)
          this.picData = res.data.data.pictureFiles ? res.data.data.pictureFiles : []
          this.modifyDetail2()
        } else {
          this.open('error', res.data.msg)
        }
    ...
    modRecord (row) { // 修改轨迹
      Loading.service({text: 'Loading', spinner: 'el-icon-loading', background: 'rgba(0, 0, 0, 0.6)'})
      api('/baseCooComAgreement/agreementVerifyList', 'post', {
    ...
    aftershowDetail (row) { // 修改后 查看
      Loading.service({text: 'Loading', spinner: 'el-icon-loading', background: 'rgba(0, 0, 0, 0.6)'})
      api('/baseCooComAgreement/findByAgreementno', 'post', {
        agreementno: row.agreementno
      }).then(res => {
        this.loadingCLose()
        if (res.data.code === '000000') {
    ...
    delPic (file, index) { // 将已经上传的文件删除
      this.picData.splice(index, 1)
      for (let i = 0; i < this.tempFjfileList.length; i++) {
        if (this.tempFjfileList[i] === file) {
          api('/baseCooComAgreement/pictureDelete', 'post',
            {
              fileName: file
            }).then(res => {
              if (res.data.code === '000000') {
                this.tempFjfileList.splice(i, 1)
              }
            })
        }
      }
    ...
    closeCoo () {
      ...
      this.orgList = []
      this.add_dialog = false
      let delayDel = () => { // 若上传了文件后直接关闭详情弹窗，此时需要将先前上传的文件删除
  ...
  mounted () {
    api(`/auth/findButtonByUserCodeAndPage?userId=${this.$store.state.login.loginUserId}&page=合作经代公司寿险协议管理`, 'get').then(result => {
      console.log(result)
    ...
    'baseCoolifeagreementhis.agreementno': {
      handler (newValue, oldValue) {
        if (newValue === undefined) {
          if (this.info.title === '合作经代公司寿险协议修改' && this.orgList.length === 1) {
            this.baseCoolifeagreementhis.agreementno = this.orgList[0].agreementno
          } else {
