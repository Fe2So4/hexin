  ...
  <div id="orgadd" >
      <ui-notice-bar slot="breadcast" >
        <el-breadcrumb slot="location" separator=">">
            ...
            <el-breadcrumb-item>离职单管理超级权限</el-breadcrumb-item>
          </el-breadcrumb>
      </ui-notice-bar>
        ...
        <el-form  ref="queryInfo" :rules="rules1" :model="queryInfo">
          ...
          <div class="btn-container">
            <el-form-item >
              ...
              <el-button type="primary" @click="importDialogOpen">批量导入</el-button>
            </el-form-item>
          </div>
        </el-form>
      </div>
...
export default {
  ...
  methods: {
    ...
    quitListMgrchangeQuitList (info) {
      api('/leaveAgent/getLeaveAgentInfo', 'post', `policyNo=${info}`).then(result => {
        if (result.data.code !== '000000') {
          ...
          api('/leaveAgent/superCheckLeaveAgent', 'post', this.quitListDetail).then(result => {
            console.log(result)
    ...
    uploadUrl () {
      return '/tabycore/leaveAgent/superleaveAgentReport'
    },
    ...mapActions([
