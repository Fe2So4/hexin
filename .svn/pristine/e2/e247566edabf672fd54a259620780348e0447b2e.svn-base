  ...
  <div id="newBill">
    <ui-notice-bar slot="breadcast" >
      <el-breadcrumb slot="location" separator=">">
        ...
        <el-breadcrumb-item>新契约保单回录</el-breadcrumb-item>
      </el-breadcrumb>
    </ui-notice-bar>
    <el-form class="mesg_form manage_form" :model="BillNoList" ref="BillNoList" :rules="rule">
      ...
      <ui-line-tittle :collapsible="true" >
        ...
        <div class="ri-content" slot="content" >
            ...
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.proposalNo">
                <ui-label-text :required="true" label="投保单号：" labelWidth="160" >
                  <el-input slot="text" @blur="checkNewBillNo" clearable v-model="BillNoList.lifePCMainCondition.proposalNo" ></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.policyNo">
                <ui-label-text :required="true" label="保单号：" labelWidth="160" >
                  <el-input slot="text" @blur="checkNewPolicyNo" clearable v-model="BillNoList.lifePCMainCondition.policyNo" ></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row >
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.policyStatus">
            ...
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.acceptDate">
                <ui-label-text :required="true"  label="承保日期：" labelWidth="160" >
                  <el-date-picker value-format="timestamp" v-model="BillNoList.lifePCMainCondition.acceptDate" slot="text" type="date" placeholder="选择日期"></el-date-picker>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.generateDate">
                <ui-label-text :required="true" label="生效日期：" labelWidth="160" >
                  <el-date-picker v-model="BillNoList.lifePCMainCondition.generateDate" slot="text" type="date" placeholder="选择日期" value-format="timestamp"></el-date-picker>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <el-form-item>
                <ui-label-text label="缴至日期：" labelWidth="160" >
                  <el-date-picker v-model="BillNoList.lifePCMainCondition.jzDate" slot="text" type="date" placeholder="选择日期" value-format="timestamp" ></el-date-picker>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.bdYear">
                <ui-label-text :required="true" label="保单年度：" labelWidth="160" >
            ...
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.companyCode">
                <ui-label-text :required="true" label="归属保险公司代码：" labelWidth="160" >
                  <el-input slot="text" clearable placeholder="双击选择" @dblclick.native="getComInfo(1)" v-model="BillNoList.lifePCMainCondition.companyCode" @blur="blurInsCom($event, 0)"></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item>
                <ui-label-text label="出单渠道："  labelWidth="160" >
                  <el-select slot="text" :disabled='allInput' v-model="BillNoList.lifePCMainCondition.businessNature" placeholder="请选择">
            ...
            <el-col :span="12">
              <el-form-item>
                <ui-label-text label="业务类型：" labelWidth="160" >
                  <el-select :disabled='allInput' slot="text" v-model="BillNoList.lifePCMainCondition.busiType" placeholder="请选择">
            ...
            <el-col :span="12">
              <el-form-item >
                <ui-label-text label="回执签收日期：" labelWidth="160" >
                  <el-date-picker value-format="timestamp" v-model="BillNoList.lifePCMainCondition.backMsgSignDate" slot="text" type="date" placeholder="选择日期"></el-date-picker>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <el-form-item >
                <ui-label-text label="回访日期：" labelWidth="160" >
                  <el-date-picker value-format="timestamp" v-model="BillNoList.lifePCMainCondition.hfDate" slot="text" type="date" placeholder="选择日期"></el-date-picker>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <el-form-item >
                <ui-label-text label="更新时间: " labelWidth="160" >
                  <el-date-picker :disabled='allInput' format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss" v-model="BillNoList.lifePCMainCondition.updateTime" slot="text" type="date" placeholder="选择日期"></el-date-picker>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item prop="lifePCMainCondition.byMyself">
                <ui-label-text :required="true" label="自保件：" labelWidth="160" >
                  <el-select slot="text" :disabled='allInput'  v-model="BillNoList.lifePCMainCondition.byMyself" placeholder="请选择">
                    <el-option label="否" value="0"></el-option>
                    <el-option label="是" value="1"></el-option>
                  </el-select>
                </ui-label-text>
            ...
            <el-col :span="12">
              <el-form-item >
                <ui-label-text label="投保人代码：" labelWidth="160" >
                  <el-input slot="text" placeholder="双击选择"  clearable :readonly='isInput' v-model="BillNoList.lifePartyCondition.insureNo" :disabled="!isclick" @dblclick.native="isclick&&customerFindIns(1, 0, $event)"></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item>
                <ui-label-text :required='true' label="投保人名称：" labelWidth="160" >
                  <el-input slot="text" :disabled="!isclick"  :readonly='isInput' placeholder="双击选择" clearable @dblclick.native="isclick&&customerFindIns(1, 0, $event)" v-model="BillNoList.lifePartyCondition.insureName" ></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <el-form-item >
                <ui-label-text label="出生日期：" labelWidth="160" >
                  <el-date-picker :disabled='isInput'  v-model="BillNoList.lifePartyCondition.birthDate" slot="text" type="date" value-format="timestamp" placeholder="选择日期"></el-date-picker>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item >
                <ui-label-text  label="备注：" labelWidth="160" >
                  <el-input slot="text" :disabled="!isclick" clearable v-model="BillNoList.lifePartyCondition.remark" ></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="12" >
              <el-form-item>
                <ui-label-text :required='true' label="证件有效期：" labelWidth="160" >
                  <el-date-picker value-format="timestamp" style="width: 40%; margin-right: 9%; " :disabled="longFlagTag" v-model="BillNoList.lifePartyCondition.identifyValiddate" slot="text" type="date" placeholder="选择日期"></el-date-picker>
                  <el-checkbox style="display: inline-block; " slot="text" :disabled='isInput'  size='mini' v-model="BillNoList.lifePartyCondition.longFlagtag" @change="checkChange" >终身</el-checkbox>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
              ...
              <el-col :span="12">
                <el-form-item >
                  <ui-label-text label="被保险人代码：" labelWidth="160" >
                    <el-input slot="text" @dblclick.native="isclick&&customerFindIns(1, 1, $event, index)" :readonly='item.isInput' :disabled='item.isclick' placeholder="双击选择" v-model="item.insureNoD" clearable ></el-input>
                  </ui-label-text>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item >
                  <ui-label-text :required="true" label="被保险人名称：" labelWidth="160" >
                    <el-input slot="text" @dblclick.native="isclick&&customerFindIns(1, 1, $event, index)" :readonly='item.isInput' :disabled='item.isclick' placeholder="双击选择"  v-model="item.insureNameD" clearable ></el-input>
                  </ui-label-text>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-table-column prop="riskName" label="险种名称" width="250" >
              <template slot-scope="scope">
                <el-form-item :prop="'lifeCItemKindConditionList.' + scope.$index +'.riskName'" :rules="riskRules.riskName">
                  <ui-label-text :required="true" >
                    <el-input slot="text" :readonly="true" size='mini' placeholder="双击可选择" clearable v-model="scope.row.riskName" @dblclick.native="getRiskList(1, scope.$index, scope.row, 0)"></el-input>
                  </ui-label-text>
                </el-form-item>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="premium" label="应缴保费" width="200">
              <template slot-scope="scope">
                <el-form-item  :prop="'lifeCItemKindConditionList.' + scope.$index +'.premium'" :rules="riskRules.premium">
                  <ui-label-text :required="true" >
                    <el-input size='mini' @change='addpremium' @blur="addFloat(scope.$index, 0, 0)" slot="text" v-model="scope.row.premium" ></el-input>
                  </ui-label-text>
                </el-form-item>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="addPremium" label="加费金额" width="120">
              <template slot-scope="scope">
                <el-form-item :prop="'lifeCItemKindConditionList.' + scope.$index +'.addPremium'" :rules="riskRules.addPremium">
                  <ui-label-text>
                    <el-input size='mini'  slot="text" v-model="scope.row.addPremium" @change="addFloat(scope.$index, 0, 3)"></el-input>
                  </ui-label-text>
                </el-form-item>
              </template>
            </el-table-column>
      ...
      <ui-line-tittle :collapsible="true" >
        ...
        <div class="ri-content" slot="content" >
          <el-table stripe border :data="BillNoList.lifeChargeConditionList" style="width: 100%" class="riskTable">
            <el-table-column prop="riskCode" label="险种代码" width='200'>
              <template slot-scope="scope">
            ...
            <el-table-column prop="riskName" label="险种名称" width='200'>
              <template slot-scope="scope">
                <el-form-item :prop="'lifeChargeConditionList.' + scope.$index +'.riskName'" :rules="riskRules.riskName">
                  <ui-label-text :required="true" >
                    <el-input slot="text" :readonly="true" size='mini' placeholder="双击可选择" clearable v-model="scope.row.riskName" @dblclick.native="getRiskList(1, scope.$index, scope.row, 1)" ></el-input>
                  </ui-label-text>
                </el-form-item>
              </template>
            </el-table-column>
            <el-table-column prop="paidPremium" label="实收保费">
              <template slot-scope="scope">
            ...
            <el-table-column prop="payDate" label="实收日期">
              <template slot-scope="scope">
                <el-form-item prop="payDate">
                  <ui-label-text :required="true" >
                    <el-date-picker size="mini" slot="text" v-model="scope.row.payDate" align="right" type="date" placeholder="选择日期" value-format="timestamp"></el-date-picker>
                  </ui-label-text>
                </el-form-item>
              </template>
            </el-table-column>
      ...
      <div class="btn-container">
        <el-button type="primary" @click.prevent="newBillPut" >提交</el-button>
        <el-button type="primary" @click.prevent="isImport = true" >批量导入</el-button>
      </div>
    </el-form>
    <!-- 补录回访日期 -->
    <el-dialog title="信息修改" @close='closeDate' center :append-to-body='true' :visible.sync="isDate" width="40%" >
      <el-form>
        <el-row >
          <el-col :span="24">
            <el-form-item>
              <ui-label-text label="回执签收日期：" labelWidth="160" >
                <el-date-picker value-format="yyyy-MM-dd" v-model="dateForm.backMsgSignDate" slot="text" type="date" placeholder="选择日期"></el-date-picker>
              </ui-label-text>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item>
              <ui-label-text label="回访日期：" labelWidth="160" >
                <el-date-picker value-format="yyyy-MM-dd" v-model="dateForm.hfDate" slot="text" type="date" placeholder="选择日期"></el-date-picker>
              </ui-label-text>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item>
              <ui-label-text label="回访状态：" labelWidth="160" >
                <el-select  slot="text"  v-model="dateForm.hfStatus" placeholder="请选择">
                  <el-option label="未回访" value="1"></el-option>
                  <el-option label="成功" value="2"></el-option>
                  <el-option label="失败" value="3"></el-option>
                </el-select>
      ...
      <div class="btnStyle">
        ...
        <el-button type="primary" @click="trueHfDate">确 定</el-button>
      </div>
    </el-dialog>
     <!-- 上传弹框 -->
    <el-dialog :append-to-body='true' @close='closeImp' center width='40%' title="保单信息导入"  :visible.sync="isImport" >
      <ui-line-tittle :collapsible="true" >
        <span slot="title" >
            <i class="font_family icon-jy-menu-4" ></i>保单信息导入
        </span>
        <div class="ri-content" slot="content">
          <div class="download">
          ...
          <div class="upLoad">
            <el-upload class="upload-demo" ref="upload"  name="file" :on-success="handleSuccess" :action="uploadUrl()" :limit="1" accept='xls' :file-list="fileList" :auto-upload="false">
          ...
          <el-col :span="12">
            <el-form-item  prop="comName" >
              <ui-label-text  label="归属机构名称:" :required="true" labelWidth="130">
                <el-input clearable :disabled="true" @blur="blurOrg($event, 1)"  v-model="addCustom.comName" slot="text" ></el-input>
              </ui-label-text>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="12" >
            <el-form-item prop="identifyValiddate">
              <ui-label-text :required='true' label="证件有效期：" labelWidth="130" >
                ...
                <el-checkbox style="display: inline-block; " slot="text" :disabled='addCustom.isInput'  size='mini' v-model="addCustom.longFlagtag" @change="checkChangeCus" >终身</el-checkbox>
              </ui-label-text>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  mounted () {
    this.$nextTick(function () {
      ...
      this.getTimeDate()
      this.addFeeItem()
      this.BillNoList.lifePCMainCondition.insuranceMark = '1'
    })
  },
  watch: {
  ...
  methods: {
    checkNewBillNo () {
      ...
      if (this.BillNoList.lifePCMainCondition.proposalNo === '') {
        // this.open('error', '请输入正确的投保单号！')
        return false
      } else {
        this.checkBillNo(this.BillNoList.lifePCMainCondition.proposalNo).then(resp => {
          if (resp.code === '000000') {
            let returnString = resp.data
            if (returnString === 'non') {
              this.open('error', '您输入的投保单号没有对应的投保信息，请保证投保单号的正确性，然后继续录入其他信息！')
              this.BillNoList.lifePCMainCondition.proposalNo = ''
              return false
            } else if (returnString === 'three') {
              this.BillNoList.lifePCMainCondition.proposalNo = ''
              this.open('error', '该投保单暂未审核通过！禁止回录！')
              return false
            } else if (returnString === 'wrong') {
              this.BillNoList.lifePCMainCondition.proposalNo = ''
              this.open('error', '您输入的投保单号对应的投保信息已注销或已承保或未审核通过，请输入正确信息！')
              return false
            } else if (returnString === 'hfWrite') { // 确认是否需要补录保单回执签收日期和回访状态和回访日期
              // 弹框
              let postData = {
                'proposalNo': this.BillNoList.lifePCMainCondition.proposalNo,
                'type': '0'
              }
              this.searchHfDate(postData).then(resp => { //  0投保单 1 保单
                if (resp.code === '000000') {
                  this.isDate = true
                  this.dateForm.backMsgSignDate = resp.data.backMsgSignDate
                  if (resp.data.hfStatus === '' || resp.data.hfStatus === null) {
                    this.isHf = false
                  } else {
                    this.isHf = true
                  }
                  this.dateForm.hfStatus = resp.data.hfStatus
                  this.dateForm.policyNo = resp.data.policyNo
                }
              })
            } else if (returnString === 'repet') {
              this.BillNoList.lifePCMainCondition.proposalNo = ''
              this.open('error', '该投保单已完成信息回录，请不要重复操作！')
              return false
            } else {
              let post = this.BillNoList.lifePCMainCondition.proposalNo
              this.getProposalDetail(post).then(resp => {
                if (resp.code === '000000') {
                  // 基本信息 开始
                  this.BillNoList.lifePCMainCondition = resp.data.lifetPCMain
                  this.BillNoList.lifePCMainCondition.insuranceMark = '1'
                  this.BillNoList.lifePCMainCondition.acceptDate = ''
                  this.allInput = true
                  this.isSg = true
                  this.isSc = true
                  this.getTimeDate()
                  ...
                  let sgList = []
                  let scList = []
                  if (!IsEmpty(resp.data.lifetParty)) {
                    resp.data.lifetParty.forEach((item, index) => {
                      if (item.partyFlag === '1') { // 投保人
                        this.isclick = false
                        this.isEdit = true
                        this.BillNoList.lifePartyCondition.identifyName = item.identifyName // 证件名称
                        this.BillNoList.lifePartyCondition.insureNo = item.partyCode
                        this.BillNoList.lifePartyCondition.insureName = item.partyName
                        this.BillNoList.lifePartyCondition.insureAddress = item.partyAddress
                        this.BillNoList.lifePartyCondition.postNo = item.postCode
                        this.BillNoList.lifePartyCondition.sexType = item.sexType
                        this.BillNoList.lifePartyCondition.country = item.country
                        this.BillNoList.lifePartyCondition.birthDate = item.birthday
                        this.BillNoList.lifePartyCondition.remark = item.remark
                        this.BillNoList.lifePartyCondition.marriage = item.marriage
                        this.BillNoList.lifePartyCondition.educationCode = item.education
                        this.BillNoList.lifePartyCondition.identifyType = item.identifyType
                        this.BillNoList.lifePartyCondition.identifyNumber = item.identifyNumber
                        this.BillNoList.lifePartyCondition.longFlag = item.longFlag
                        if (item.longFlag === 0) {
                          this.BillNoList.lifePartyCondition.identifyValiddate = item.identifyValiddate
                        ...
                        this.BillNoList.lifePartyCondition.insureTel = item.homePhone
                        this.BillNoList.lifePartyCondition.mobilePhone = item.mobilPhone
                        this.BillNoList.lifePartyCondition.workingUnit = item.workingUnit
                        this.BillNoList.lifePartyCondition.job = item.job
                        this.BillNoList.lifePartyCondition.e_mail = item.email
                        this.BillNoList.lifePartyCondition.weixin = item.weixin
                        this.BillNoList.lifePartyCondition.habitualResidence = item.habitualResidence
                        this.BillNoList.lifePartyCondition.insuredrType = item.insuredrType
                        this.BillNoList.lifePartyCondition.insuredrName = item.insuredrName
                        this.isInput = true
                      } else if (item.partyFlag === '2') { // 被保险人
                        insured.push(item)
                      } else if (item.partyFlag === '3') { // 身故受益人
                        sgList.push(item)
                      } else {
                        scList.push(item)
                      }
                    ...
                    insured.forEach((item, index) => { // 被保险人
                      let jsonStrIns = {}
                      jsonStrIns.insureNoD = item.partyCode // 被保险人代码
                      jsonStrIns.insureNameD = item.partyName
                      jsonStrIns.insureAddressD = item.partyAddress
                      jsonStrIns.postNoD = item.postCode
                      jsonStrIns.sexTypeD = item.sexType
                      jsonStrIns.countryD = item.country
                      jsonStrIns.educationCodeD = item.education
                      jsonStrIns.marriageD = item.marriage
                      jsonStrIns.birthDateD = item.birthday
                      jsonStrIns.remark = item.remark
                      jsonStrIns.identifyTypeD = item.identifyType
                      jsonStrIns.identifyNameD = item.identifyName
                      jsonStrIns.identifyNumberD = item.identifyNumber
                      jsonStrIns.longFlagD = item.longFlag
                      jsonStrIns.partyFlagD = '2'
                      if (jsonStrIns.longFlagD === 1) {
                        jsonStrIns.longFlagtag = true
                        jsonStrIns.identifyValiddateD = ''
                      } else {
                        jsonStrIns.longFlagtag = false
                        jsonStrIns.identifyValiddateD = item.identifyValiddate
                      }
                      jsonStrIns.insureTelD = item.partyPhone
                      jsonStrIns.mobilePhoneD = item.mobilPhone
                      jsonStrIns.workingUnitD = item.workingUnit
                      jsonStrIns.jobD = item.job
                      jsonStrIns.e_mailD = item.email
                      jsonStrIns.weixinD = item.weixin
                      jsonStrIns.habitualResidenceD = item.habitualResidence
                      jsonStrIns.isclick = true
                      jsonStrIns.isInput = true
                      jsonStrIns.longFlagTag = true
                      jsonStrIns.serialNoD = '2'
                      jsonStrIns.partyTypeD = '1'
                      this.BillNoList.lifePartyConditionDList.push(jsonStrIns)
                      // this.$set(this.BillNoList.lifePartyConditionDList[index], 'longFlagTag', true)
                    })
                    if (!IsEmpty(sgList)) {
                      sgList.forEach((item, index) => { // 身故受益人
                        let jsonStr = {}
                        jsonStr.partyName = item.partyName // 姓名
                        jsonStr.identifyType = item.identifyType // 证件类型
                        jsonStr.identifyNumber = item.identifyNumber // 证件号
                        jsonStr.sex = item.sexType // 性别
                        jsonStr.birthdate = item.birthday // 出生日期
                        jsonStr.remark = item.remark // 备注
                        jsonStr.beneficialOrder = item.beneficialOrder // 收益顺序
                        jsonStr.benefitShare = item.benefitShare // 收益份额
                        jsonStr.insuredrType = item.insuredrType // 与被保险人关系
                        jsonStr.insuredrName = item.insuredrName // 关系名称
                        jsonStr.phone = item.linkPhone // 联系方式
                        jsonStr.habitualResidence = item.habitualResidence // 经常居住地
                        jsonStr.longFlag = item.longFlag // 省份证长期
                        jsonStr.serialNo = '2'
                        jsonStr.partyFlag = '3'
                        this.$set(jsonStr, 'longFlagTag', true)
                        if (jsonStr.longFlag === 1) {
                          jsonStr.identifyValiddate = '' // 证件有效期
                          jsonStr.longFlagtag = true
                        } else {
                          jsonStr.identifyValiddate = item.identifyValiddate // 证件有效期
                          jsonStr.longFlagtag = false
                        }
                        jsonStr.isInput = true
                        jsonStr.isEdit = true
                        this.BillNoList.lifePartyTConditionList.push(jsonStr)
                      })
                    }
                    if (!IsEmpty(sgList)) {
                      scList.forEach((item, index) => { // 生存受益人
                        let jsonStrSc = {}
                        jsonStrSc.partyName = item.partyName // 姓名
                        jsonStrSc.identifyType = item.identifyType // 证件类型
                        jsonStrSc.identifyNumber = item.identifyNumber // 证件号
                        jsonStrSc.sex = item.sexType // 性别
                        jsonStrSc.birthdate = item.birthday // 出生日期
                        jsonStrSc.remark = item.remark // 备注
                        jsonStrSc.beneficialOrder = item.beneficialOrder // 收益顺序
                        jsonStrSc.benefitShare = item.benefitShare // 收益份额
                        jsonStrSc.insuredrType = item.insuredrType // 与被保险人关系
                        jsonStrSc.insuredrName = item.insuredrName // 关系名称
                        jsonStrSc.phone = item.linkPhone // 联系方式
                        jsonStrSc.habitualResidence = item.habitualResidence // 经常居住地
                        jsonStrSc.longFlag = item.longFlag // 身份证长期
                        jsonStrSc.partyFlag = '4'
                        jsonStrSc.serialNo = '2'
                        this.$set(jsonStrSc, 'longFlagTag', true)
                        if (jsonStrSc.longFlag === 1) {
                          jsonStrSc.identifyValiddate = '' // 证件有效期
                          jsonStrSc.longFlagtag = true
                        } else {
                          jsonStrSc.identifyValiddate = item.identifyValiddate // 证件有效期
                          jsonStrSc.longFlagtag = false
                        }
                        jsonStrSc.isEdit = true
                        jsonStrSc.isInput = true
                        this.BillNoList.lifePartyAConditionList.push(jsonStrSc)
                      })
                    }
                  }
                  this.BillNoList.lifeCItemKindConditionList = resp.data.lifetCItemKindListVo
                  if (!IsEmpty(this.BillNoList.lifeCItemKindConditionList)) {
                  ...
                  if (!IsEmpty(resp.data.lifetFee)) {
                    this.BillNoList.lifeFeeCondition = resp.data.lifetFee
                  } else {
                    this.BillNoList.lifeFeeCondition = {}
                  }
                  if (!IsEmpty(resp.data.traBankFirstalName)) {
                    this.BillNoList.lifeFeeCondition.bankName = resp.data.traBankFirstalName
                  } else {
                    this.BillNoList.lifeFeeCondition.bankName = ''
                  }
                }
              })
            }
    ...
    trueHfDate () {
      this.Loading()
      this.policyDateModify(this.dateForm).then(resp => {
        this.closeLoading()
        if (resp.code === '000000') {
          this.isDate = false
    ...
    checkNewPolicyNo () { // 校验保单号
      this.dateForm = {
        backMsgSignDate: '',
        hfDate: '',
        hfStatus: ''
      }
      if (this.BillNoList.lifePCMainCondition.policyNo === '') {
        // this.open('error', '请输入正确的保单号！')
        return false
      } else {
        this.valiPolicyNo_newBill(this.BillNoList.lifePCMainCondition.policyNo).then(resp => {
          if (resp.code === '000000') {
            if (resp.data === 'true') { // 需要回录日期
              let postData = {
                'policyNo': this.BillNoList.lifePCMainCondition.policyNo,
                'type': '1'
              }
              this.searchHfDate(postData).then(resp => { //  0投保单 1 保单
                if (resp.code === '000000') {
                  ...
                  this.dateForm.hfStatus = resp.data.hfStatus
                  if (resp.data.hfDate === null) {
                    this.dateForm.hfDate = ''
                  }
                  this.dateForm.hfDate = resp.data.hfDate
                  this.dateForm.policyNo = this.BillNoList.lifePCMainCondition.policyNo
                  this.isDate = true
                }
              })
            } else if (resp.data === 'false') {
              this.BillNoList.lifePCMainCondition.policyNo = ''
              this.open('error', '该保单已完成信息回录，请不要重复操作！')
            }
          } else {
            this.open('error', resp.msg)
          }
    ...
    newBillPut () { // 新契约保存
      ...
      if (this.BillNoList.lifePCMainCondition.generateDate <= this.BillNoList.lifePCMainCondition.proposalDate) {
        this.open('error', '生效日期必须大于投保日期！')
        return false
      }
      console.log(this.BillNoList.lifePCMainCondition.backMsgSignDate)
      if (this.BillNoList.lifePCMainCondition.backMsgSignDate !== '' && this.BillNoList.lifePCMainCondition.backMsgSignDate !== null) {
        if (this.BillNoList.lifePCMainCondition.backMsgSignDate < this.BillNoList.lifePCMainCondition.acceptDate) {
          this.open('error', '回执签收日期不能早于承保日期，请调整！')
          return false
        }
      }
      if (this.BillNoList.lifePartyCondition.longFlagtag) { // 身份证是否长 期有效 投保人
        ...
        if (this.BillNoList.lifePCMainCondition.proposalDate > this.BillNoList.lifePartyCondition.identifyValiddate) {
          this.open('error', '投保人证件有效期到期日不能早于投保日期，请调整！')
          return false
        }
      }
      ...
      this.BillNoList.lifePartyConditionDList.forEach((item, index) => { // 被保险人
        if (item.longFlagtag) { // 身份证是否长期有效
          ...
          item.longFlagD = 0
          if (this.BillNoList.lifePCMainCondition.proposalDate > item.identifyValiddateD) {
            insured = 2
            this.isContinue = false
            return false
          }
      ...
      if (insured === 1) {
        ...
        this.open('error', '被保险人证件有效期到期日不能早于投保日期，请调整！')
        this.isContinue = false
        return false
      } else if (insured === 3) {
      ...
      if (this.BillNoList.lifeCItemKindConditionList.length <= 0) {
        ...
        this.BillNoList.lifeCItemKindConditionList.forEach((item, index) => { // 险种
          ...
          if (item.startDate === '' || item.startDate === undefined || item.startDate === null) {
            ...
            return false
          } else if (item.endDate !== '' && item.lifeFlagtag === false && item.endDate !== null) {
      ...
      fjRisk.forEach((item, index) => {
        mainRisk.forEach((list, i) => {
          if (item.paymentPeriod > list.paymentPeriod) { // 附加险大于主险期限
            fjContinue = false
          }
        })
      })
    ...
    postNewBill () {
      this.$refs['BillNoList'].validate((valid) => {
        if (valid && this.isContinue) {
          ...
          this.BillNoList.lifePCMainCondition.flag = '1' // 基础信息隐藏信息
          this.BillNoList.lifePCMainCondition.surrenderFlag = '0' // 基础信息隐藏信息
          this.BillNoList.lifePCMainCondition.insuranceMark = '1' // 基础信息隐藏信息
          this.BillNoList.lifePCMainCondition.businessNature = '1' // 基础信息隐藏信息
          this.BillNoList.lifePCMainCondition.busiType = '1' // 基础信息隐藏信息
          this.BillNoList.lifePartyCondition.proposalNoFlag = '0' // 投保人隐藏信息
          this.BillNoList.lifeChargeConditionList.flag = '0'
          this.Loading()
          this.savePolicy_newBill(this.BillNoList).then(resp => {
            this.closeLoading()
            if (resp.code === '000000') {
              this.open('success', '回录成功！')
              this.isInput = false
              this.BillNoList = { // 个保单详情
                lifePCMainCondition: { // 基本信息
                  'proposalNo': '', // 投保单号
                  'policyNo': '', // 保单号
                  'policyStatus': '', // 保单状态
          ...
          this.open('error', '页面信息录入有误，请仔细检查！')
        }
      })
    },
    downModule () { // 下载模板
      window.open('/tabycore/lifeManage/downloadModel')
    },
    uploadUrl () { // 文件上传地址
      return '/tabycore/lifeManage/singlePolicyImport'
    },
    submitUpload () { // 上传到服务器
    ...
    selectRowOrg (row) { // 公司机构选择
      this.closeDailog().then(() => {
        if (this.orgTag === 0) {
          ...
          this.$set(this.addCustom, 'comName', row.comCName)
        }
        this.org_dialog = false
      })
    },
    ...
    selectRowRisk (row) { // 选择险种
      this.closeDailog().then(() => {
        if (this.riskTag === 0) { // 险种信息
          ...
          this.BillNoList.lifeChargeConditionList.forEach((item, index) => {
            if (row.riskcode === item.riskCode) {
              isRiskTag = true
            }
          })
    ...
    getTimeDate () {
      ...
      this.BillNoList.lifePCMainCondition.updateTime = this.timeFormate()
    },
    timeFormate () {
      var nowTime = ''
    ...
    ...mapActions([
      ...
      'getInsCom_newBill',
      'getInsOrg_newBill',
      'customerFind_newBill',
      'getProposalDetail',
      'agentFind_newBill',
      'riskcode_newBill',
      'getAllBank_newBill',
      'savePolicy_newBill',
      'valiPolicyNo_newBill',
      'allOrg_newBill',
      'customerAdd_NewBill',
      'customerIsExist_NewBill',
      'customerSimilar_NewBill'
    ])
  },
  components: {
...
<style>
  ...
  #newBill .riskTable .el-form-item__error { left: 20px;}
