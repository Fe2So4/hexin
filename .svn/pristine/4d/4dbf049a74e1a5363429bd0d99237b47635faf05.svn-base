<template>
  <div id="orgadd" >
      ...
      <div class="ri-content" slot="content" >
        <el-form ref="lifecaiwuExamine" :rules="rules" :model="queryInfo">
          <el-row class="ri-line">
            <el-col :span="12">
              <el-form-item prop='comCode'>
                <ui-label-text :required="true" labelWidth="180" label="佰盈机构代码：" >
                  <el-input v-model="queryInfo.comCode" slot="text" @input="baiyingchange(1)" @dblclick.native="openComDialog(0)" placeholder="双击可选择" @blur='opensingleComDialog(0)' clearable></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop='comName'>
                <ui-label-text labelWidth="180" label="佰盈机构名称:" >
                  <el-input v-model="queryInfo.comName" slot="text" @input="baiyingchange(2)" @dblclick.native="openComDialog(0)" placeholder="双击可选择" @blur='opensingleComDialog(0)' clearable></el-input>
                </ui-label-text>
              </el-form-item>
            </el-col>
          </el-row>
      ...
      <div class="btn-container" slot="controlbar" >
          <el-button type="primary" @click.native.prevent="submitForm('lifecaiwuExamine', 0)">查询</el-button>
          <!-- <el-button type="primary" @click.native.prevent="submitForm('lifecaiwuExamine', 1)">导出</el-button> -->
      </div>
      <div v-if="tableShowOrnot">
        <el-table ref="multipleTable" stripe @selection-change="handleSelectionChange" tooltip-effect="dark" style="width: 100%" :data="tableData">
          <el-table-column prop="batchNo" label="对账单号"  width="200" show-overflow-tooltip>
            <template slot-scope="scope" >
              <span @click="getDetailExamine(scope.row)" class="tableButton">{{ scope.row.batchNo }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="companyName" label="保险公司" show-overflow-tooltip width="300"></el-table-column>
          <el-table-column prop="comName" label="佰盈公司" show-overflow-tooltip width="300"></el-table-column>
          ...
          <el-table-column prop="reconinsertDateStr" label="对账单生成日期" width="150"></el-table-column>
      ...
      <el-dialog :append-to-body='true' stripe :visible.sync='comDialog2' :before-close='childClose'>
        <div>
          <el-table @row-click='changeData' ref="multipleTable" :data="tempTableData3">
      ...
      <el-dialog :append-to-body='true' stripe :visible.sync='comDialog3' :before-close='childClose1'>
        <div>
          <el-table @row-click='changeData1' ref="multipleTable" :data="tempTableData4">
      ...
      <el-dialog :append-to-body='true' :visible.sync='comDialog4' :before-close='childClose2'>
        <div>
          <el-table @row-click='changeData2' stripe ref="multipleTable" :data="tempTableData5">
      ...
      <el-dialog :append-to-body='true' :visible.sync='comDialog5' :before-close='childClose3'>
        <div>
          <el-table @row-click='changeData3' stripe ref="multipleTable" :data="tempTableData6">
      ...
      <el-dialog :append-to-body='true' :visible.sync='comDialog6' :before-close='childClose4'>
        <div>
          <el-table @row-click='changeData4' stripe ref="multipleTable" :data="tempTableData7">
      ...
      <el-dialog append-to-body center title="开票信息导入"
        ...
        <div class="upload-content">
          <el-upload
            ...
            name="fileName"
            action="/tabycore/lifeCharge/lifeChargeimportInvoice"
            :limit="1"
      ...
      <el-dialog :append-to-body='true' width="90%" :visible.sync='detailDialogVis' :before-close="childClose5">
        <ui-line-tittle v-if="chargeType === 1 || chargeType === '1' || !chargeType" :collapsible="true" >
          <span slot="title" >
          ...
          <div class="ri-content" slot="content" >
            <el-table ref="multipleTable" stripe tooltip-effect="dark" style="width: 100%" :data="kaipiaoTableData">
              ...
              <el-table-column prop="policyyear" label="保单年度" width="200"></el-table-column>
              <el-table-column prop="mainflag" label="主/附险" width="200"></el-table-column>
        ...
        <ui-line-tittle :collapsible="true" >
          ...
          <div class="ri-content" slot="content" >
            ...
            <el-row class="ri-line">
              <el-col :span="12">
                <ui-label-text label="对账总手续费6%(含税)：" labelWidth="160" :text="detailDialogData.spsl6Mount">
                </ui-label-text>
              </el-col>
              <el-col :span="12">
                <ui-label-text label="对账总手续费3%(含税)：" labelWidth="160" :text="detailDialogData.spsl3Mount">
                </ui-label-text>
              </el-col>
            </el-row>
            <el-row class="ri-line">
            ...
            <el-row class="ri-line">
              <el-col :span="12">
                <ui-label-text label="首期总手续费：" labelWidth="160" :text="detailDialogData.sqCalHandMount">
                </ui-label-text>
              </el-col>
              <el-col :span="12">
                <ui-label-text label="首期手续费：" labelWidth="160" :text="detailDialogData.firstPoundage">
                </ui-label-text>
              </el-col>
            </el-row>
            <el-row class="ri-line">
              ...
              <el-col :span="12">
                <ui-label-text label="继续率奖金：" labelWidth="160" :text="detailDialogData.jxljj">
                </ui-label-text>
              </el-col>
            </el-row>
            <el-row class="ri-line">
              <el-col :span="12">
                <ui-label-text label="首期总对总方案手续费：" labelWidth="160" :text="detailDialogData.alltoallPoundage">
                </ui-label-text>
              </el-col>
              <el-col :span="12">
                <ui-label-text label="首期分对分方案手续费：" labelWidth="160" :text="detailDialogData.fentofenPoundage">
                </ui-label-text>
              </el-col>
            </el-row>
            <el-row class="ri-line">
        ...
        <ui-line-tittle :collapsible="true"  v-if="chargeType === 1 || chargeType === '1' || !chargeType">
          ...
          <div class="ri-content" slot="content">
            <div id="ticketDetail" v-for="(item, index) of kaipInfo" :key="index">
              <span>发票详情信息</span>
              <el-form :ref="`detailDialogRefs${index}`" :rules="rules1" :model="kaipInfo[index]">
                <el-row class="ri-line">
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="开票机构代码:" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='comcomcode'>
                      <el-input v-model="item.comcomcode" @dblclick.native="openComDialog(3, index)" placeholder="双击可选择"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="开票机构名称:" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                  ...
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="公司段代码：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                  ...
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="公司段名称：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                ...
                <!-- <el-row class="ri-line">
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="客户段代码：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                  ...
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="客户段名称：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                  ...
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="银行段代码：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                  ...
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="银行段名称：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                ...
                <el-row class="ri-line">
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="纳税人代码：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayercomcode'>
                      <el-input v-model="item.ratepayercomcode" @dblclick.native="openComDialog(2,index)" placeholder="双击可选择"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="纳税人名称：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayername'>
                      <el-input v-model="item.ratepayername" @dblclick.native="openComDialog(2,index)" placeholder="双击可选择"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="纳税人身份：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayercode'>
                      <el-select v-model="item.ratepayercode" placeholder="请选择">
                  ...
                  <el-col :span="2">
                    <ui-label-text1 :required="theTaxCom" labelWidth="60" label="纳税人地址：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayeradd'>
                      <el-input v-model="item.ratepayeradd" ></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row class="ri-line">
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="纳税人识别号：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayerno'>
                      <el-input v-model="item.ratepayerno" ></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="2">
                    <ui-label-text1 :required="theTaxCom" labelWidth="60" label="纳税人电话：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayerphone'>
                        <el-input v-model="item.ratepayerphone" ></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="2">
                    <ui-label-text1 :required="theTaxCom" labelWidth="60" label="纳税人开户行：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayerbankname'>
                      <el-input v-model="item.ratepayerbankname" ></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="2">
                    <ui-label-text1 :required="theTaxCom" labelWidth="60" label="纳税人银行账号：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                    <el-form-item prop='ratepayerbankcode'>
                      <el-input v-model="item.ratepayerbankcode" ></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row class="ri-line">
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="商品名称：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
                  ...
                  <el-col :span="2">
                    <ui-label-text1 :required="true" labelWidth="60" label="开票税率：" >
                    </ui-label-text1>
                  </el-col>
                  <el-col :span="4" class="testInput">
              ...
              <el-row class="ri-line">
                ...
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].allhandCal3" @blur='calHandCal(index,3)'></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].shuiCal3" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].priceCal3" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].aftershuiCal3"></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].afterpriceCal3"></el-input>
                </el-col>
              </el-row>
              <el-row class="ri-line">
                <el-col :span="3">
                ...
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].allhandCal4" @blur='calHandCal(index,4)'></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].shuiCal4" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].priceCal4" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].aftershuiCal4"></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].afterpriceCal4"></el-input>
                </el-col>
              </el-row>
              <el-row class="ri-line">
                <el-col :span="3">
                ...
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].allhandCal5" @blur='calHandCal(index,5)'></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].shuiCal5" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].priceCal5" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].aftershuiCal5"></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].afterpriceCal5"></el-input>
                </el-col>
              </el-row>
              <el-row class="ri-line">
                <el-col :span="3">
                ...
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].allhandCal6" @blur='calHandCal(index,6)'></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].shuiCal6" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].priceCal6" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].aftershuiCal6"></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].afterpriceCal6"></el-input>
                </el-col>
              </el-row>
              <el-row class="ri-line">
                <el-col :span="3">
                ...
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].allhandCal7" @blur='calHandCal(index,7)'></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].shuiCal7" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].priceCal7" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].aftershuiCal7"></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].afterpriceCal7"></el-input>
                </el-col>
              </el-row>
              <el-row class="ri-line">
                <el-col :span="3">
                ...
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].allhandCal8" @blur='calHandCal(index,8)'></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].shuiCal8" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].priceCal8" readonly></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].aftershuiCal8"></el-input>
                </el-col>
                <el-col :span="3" class="testInput">
                  <el-input type="number" v-model="kaipiaoInputData[index].afterpriceCal8"></el-input>
                </el-col>
              </el-row>
              <div>
...
import LabelText1 from '@/components/label-text1'
...
export default {
  ...
  data () {
    return {
      ...
      rules1: {
        ...
        comcomname: [
          { required: true, message: '请输入开票机构名称', trigger: 'change' }
        ],
        firmcode: [
  ...
  methods: {
    ...
    queryData () {
      this.Loading()
      this.tableData = []
      api('/lifeCharge/queryLifeChargeError', 'post', this.queryInfo).then((res) => {
        if (IsEmpty(res.msg)) {
          api('/lifeCharge/queryAllFinanceLifeChargePoundageRecon', 'post', this.queryInfo).then((res) => {
            this.closeLoading()
          ...
          this.openToast('warning', res.msg)
        }
      })
    },
        ...
        case 1:
          ...
          if (this.theTaxCom) {
            for (let i = 0; i < this.kaipInfo.length; i++) {
              ...
              IsEmpty(this.kaipInfo[i].ratepayercomcode) ||
              IsEmpty(this.kaipInfo[i].ratepayername) ||
              IsEmpty(this.kaipInfo[i].ratepayercode) ||
              IsEmpty(this.kaipInfo[i].ratepayeradd) ||
              IsEmpty(this.kaipInfo[i].ratepayerno) ||
              IsEmpty(this.kaipInfo[i].ratepayerphone) ||
              IsEmpty(this.kaipInfo[i].ratepayerbankname) ||
              IsEmpty(this.kaipInfo[i].ratepayerbankcode) ||
          ...
          if (!tempIsEmpty) {
            ...
            for (let i = 0; i < this.kaipiaoInputData.length; i++) {
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal1)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal1))) {
                this.openToast('warning', '发票类型：普票，首/续保标记：新保，险种类型：主险的调整后的税款必须小于调整后的价款')
                return false
              }
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal2)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal2))) {
                this.openToast('warning', '发票类型：普票，首/续保标记：新保，险种类型：附加险的调整后的税款必须小于调整后的价款')
                return false
              }
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal3)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal3))) {
                this.openToast('warning', '发票类型：普票，首/续保标记：续保，险种类型：主险的调整后的税款必须小于调整后的价款')
                return false
              }
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal4)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal4))) {
                this.openToast('warning', '发票类型：普票，首/续保标记：续保，险种类型：附加险的调整后的税款必须小于调整后的价款')
                return false
              }
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal5)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal5))) {
                this.openToast('warning', '发票类型：专票，首/续保标记：新保，险种类型：主险的调整后的税款必须小于调整后的价款')
                return false
              }
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal6)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal6))) {
                this.openToast('warning', '发票类型：专票，首/续保标记：新保，险种类型：附加险的调整后的税款必须小于调整后的价款')
                return false
              }
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal7)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal7))) {
                this.openToast('warning', '发票类型：专票，首/续保标记：新保，险种类型：附加险的调整后的税款必须小于调整后的价款')
                return false
              }
              if (Math.abs(parseFloat(this.kaipiaoInputData[i].aftershuiCal8)) > Math.abs(parseFloat(this.kaipiaoInputData[i].afterpriceCal8))) {
                this.openToast('warning', '发票类型：专票，首/续保标记：续保，险种类型：附加险的调整后的税款必须小于调整后的价款')
                return false
              }
              // 发票类型和首/续保标记各不相同，调整后税款与调整后的价款之和必须是对账总手续费（含税）的1元之内
              if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal1) + parseFloat(this.kaipiaoInputData[i].afterpriceCal1) - parseFloat(this.kaipiaoInputData[i].allhandCal1)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal1) - parseFloat(this.kaipiaoInputData[i].aftershuiCal1) - parseFloat(this.kaipiaoInputData[i].afterpriceCal1)) <= 1) {
                if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal2) + parseFloat(this.kaipiaoInputData[i].afterpriceCal2) - parseFloat(this.kaipiaoInputData[i].allhandCal2)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal2) - parseFloat(this.kaipiaoInputData[i].aftershuiCal2) - parseFloat(this.kaipiaoInputData[i].afterpriceCal2)) <= 1) {
                  if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal3) + parseFloat(this.kaipiaoInputData[i].afterpriceCal3) - parseFloat(this.kaipiaoInputData[i].allhandCal3)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal3) - parseFloat(this.kaipiaoInputData[i].aftershuiCal3) - parseFloat(this.kaipiaoInputData[i].afterpriceCal3)) <= 1) {
                    if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal4) + parseFloat(this.kaipiaoInputData[i].afterpriceCal4) - parseFloat(this.kaipiaoInputData[i].allhandCal4)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal4) - parseFloat(this.kaipiaoInputData[i].aftershuiCal4) - parseFloat(this.kaipiaoInputData[i].afterpriceCal4)) <= 1) {
                      if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal5) + parseFloat(this.kaipiaoInputData[i].afterpriceCal5) - parseFloat(this.kaipiaoInputData[i].allhandCal5)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal5) - parseFloat(this.kaipiaoInputData[i].aftershuiCal5) - parseFloat(this.kaipiaoInputData[i].afterpriceCal5)) <= 1) {
                        if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal6) + parseFloat(this.kaipiaoInputData[i].afterpriceCal6) - parseFloat(this.kaipiaoInputData[i].allhandCal6)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal6) - parseFloat(this.kaipiaoInputData[i].aftershuiCal6) - parseFloat(this.kaipiaoInputData[i].afterpriceCal6)) <= 1) {
                          if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal7) + parseFloat(this.kaipiaoInputData[i].afterpriceCal7) - parseFloat(this.kaipiaoInputData[i].allhandCal7)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal7) - parseFloat(this.kaipiaoInputData[i].aftershuiCal7) - parseFloat(this.kaipiaoInputData[i].afterpriceCal7)) <= 1) {
                            if ((parseFloat(this.kaipiaoInputData[i].aftershuiCal8) + parseFloat(this.kaipiaoInputData[i].afterpriceCal8) - parseFloat(this.kaipiaoInputData[i].allhandCal8)) <= 1 && (parseFloat(this.kaipiaoInputData[i].allhandCal8) - parseFloat(this.kaipiaoInputData[i].aftershuiCal8) - parseFloat(this.kaipiaoInputData[i].afterpriceCal8)) <= 1) {
                              temp += (parseFloat(this.kaipiaoInputData[i].allhandCal1) + parseFloat(this.kaipiaoInputData[i].allhandCal2) + parseFloat(this.kaipiaoInputData[i].allhandCal3) + parseFloat(this.kaipiaoInputData[i].allhandCal4) + parseFloat(this.kaipiaoInputData[i].allhandCal5) + parseFloat(this.kaipiaoInputData[i].allhandCal6) + parseFloat(this.kaipiaoInputData[i].allhandCal7) + parseFloat(this.kaipiaoInputData[i].allhandCal8))
                              temp1 += (parseFloat(this.kaipiaoInputData[i].afterpriceCal1) + parseFloat(this.kaipiaoInputData[i].afterpriceCal2) + parseFloat(this.kaipiaoInputData[i].afterpriceCal3) + parseFloat(this.kaipiaoInputData[i].afterpriceCal4) + parseFloat(this.kaipiaoInputData[i].afterpriceCal5) + parseFloat(this.kaipiaoInputData[i].afterpriceCal6) + parseFloat(this.kaipiaoInputData[i].afterpriceCal7) + parseFloat(this.kaipiaoInputData[i].afterpriceCal8))
                              temp2 += (parseFloat(this.kaipiaoInputData[i].aftershuiCal1) + parseFloat(this.kaipiaoInputData[i].aftershuiCal2) + parseFloat(this.kaipiaoInputData[i].aftershuiCal3) + parseFloat(this.kaipiaoInputData[i].aftershuiCal4) + parseFloat(this.kaipiaoInputData[i].aftershuiCal5) + parseFloat(this.kaipiaoInputData[i].aftershuiCal6) + parseFloat(this.kaipiaoInputData[i].aftershuiCal7) + parseFloat(this.kaipiaoInputData[i].aftershuiCal8))
                            } else {
                              this.openToast('warning', '请校验发票类型：专票，首/续保标记：续保，险种类型：附加险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                              return false
                            }
                          } else {
                            this.openToast('warning', '请校验发票类型：专票，首/续保标记：续保，险种类型：主险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                            return false
                          }
                        } else {
                          this.openToast('warning', '请校验发票类型：专票，首/续保标记：新保，险种类型：附加险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                          return false
                        }
                      } else {
                        this.openToast('warning', '请校验发票类型：专票，首/续保标记：新保，险种类型：主险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                        return false
                      }
                    } else {
                      this.openToast('warning', '请校验发票类型：普票，首/续保标记：续保，险种类型：附加险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                      return false
                    }
                  } else {
                    this.openToast('warning', '请校验发票类型：普票，首/续保标记：续保，险种类型：主险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                    return false
                  }
                } else {
                  this.openToast('warning', '请校验发票类型：普票，首/续保标记：新保，险种类型：附加险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                  return false
                }
              } else {
                this.openToast('warning', '请校验发票类型：普票，首/续保标记：新保，险种类型：主险的调整后税款与调整后的价款之和是否是对账总手续费（含税）的1元范围')
                return false
              }
            }
            ...
            if (temp - parseFloat(this.detailDialogData.calHandMount) >= -1 && temp - parseFloat(this.detailDialogData.calHandMount) <= 1) {
              if (temp3 - parseFloat(this.detailDialogData.calHandMount) >= -1 && temp3 - parseFloat(this.detailDialogData.calHandMount) <= 1) {
                ...
                this.openToast('warning', '请校验调整后的税款加上调整后的价款是否是对账单总手续费（含税）的1元范围')
                return false
              }
            } else {
              this.openToast('warning', '请校验调整后的税款加上调整后的价款是否是对账单总手续费（含税）的1元范围')
    ...
    shenhepass () { // 审核通过
      ...
      for (let i = 0; i < this.kaipiaoInputData.length; i++) {
        let tempJson = {}
        tempJson['ratepayercomcode'] = this.kaipInfo[i].ratepayercomcode
        tempJson['ratepayername'] = this.kaipInfo[i].ratepayername
        tempJson['ratepayercode'] = this.kaipInfo[i].ratepayercode
        tempJson['ratepayeradd'] = this.kaipInfo[i].ratepayeradd
        tempJson['ratepayerno'] = this.kaipInfo[i].ratepayerno
        tempJson['ratepayerphone'] = this.kaipInfo[i].ratepayerphone
        tempJson['ratepayerbankname'] = this.kaipInfo[i].ratepayerbankname
        tempJson['ratepayerbankcode'] = this.kaipInfo[i].ratepayerbankcode
        ...
        tempJson['sjhj3'] = this.kaipiaoInputData[i].allhandCal3
        tempJson['jkwctz3'] = this.kaipiaoInputData[i].afterpriceCal3
        tempJson['skwctz3'] = this.kaipiaoInputData[i].aftershuiCal3
        tempJson['sjhj4'] = this.kaipiaoInputData[i].allhandCal4
        tempJson['jkwctz4'] = this.kaipiaoInputData[i].afterpriceCal4
        tempJson['skwctz4'] = this.kaipiaoInputData[i].aftershuiCal4
        tempJson['sjhj5'] = this.kaipiaoInputData[i].allhandCal5
        tempJson['jkwctz5'] = this.kaipiaoInputData[i].afterpriceCal5
        tempJson['skwctz5'] = this.kaipiaoInputData[i].aftershuiCal5
        tempJson['sjhj6'] = this.kaipiaoInputData[i].allhandCal6
        tempJson['jkwctz6'] = this.kaipiaoInputData[i].afterpriceCal6
        tempJson['skwctz6'] = this.kaipiaoInputData[i].aftershuiCal6
        tempJson['sjhj7'] = this.kaipiaoInputData[i].allhandCal7
        tempJson['jkwctz7'] = this.kaipiaoInputData[i].afterpriceCal7
        tempJson['skwctz7'] = this.kaipiaoInputData[i].aftershuiCal7
        tempJson['sjhj8'] = this.kaipiaoInputData[i].allhandCal8
        tempJson['jkwctz8'] = this.kaipiaoInputData[i].afterpriceCal8
        tempJson['skwctz8'] = this.kaipiaoInputData[i].aftershuiCal8
        tempArr.push(tempJson)
      }
      temp['lifeChargeInvoicerateVO'] = tempArr
      if (this.detailDialogData.status === '财务复核通过') {
        ...
        this.Loading()
        api('/lifeCharge/lifeChargePoundageReconUpdateRevamp', 'post', temp).then((res) => {
          console.log(res)
          this.closeLoading()
          if (res.data === '操作成功!') {
    ...
    newshenhepass () { // 详情不可修改价税款，审核通过
      if (this.detailDialogData.status === '财务复核通过') {
        ...
        this.Loading()
        this.detailDialogData['reconno'] = this.duizhangdanNo
        api('/lifeCharge/newlifeChargePoundageReconUpdateRevamp', 'post', this.detailDialogData1).then((res) => {
          console.log(res)
          this.closeLoading()
          if (res.data === '操作成功!') {
            this.openToast('success', res.data)
    ...
    fuhepass () { // 复核通过
      if (this.detailDialogData.status === '财务复核通过') {
        ...
        if (this.chargeType === 1 || this.chargeType === '1' || IsEmpty(this.chargeType)) {
          api('/lifeCharge/lifeChargePoundageReconUpdate', 'post', temp).then((res) => {
            console.log(res)
            this.closeLoading()
            if (res.data === '操作成功!') {
              this.openToast('success', res.data)
          ...
          api('/lifeCharge/newlifeChargePoundageReconUpdate', 'post', temp).then((res) => {
            console.log(res)
            this.closeLoading()
            if (res.data === '操作成功!') {
              this.openToast('success', res.data)
    ...
    shenheNopass () { // 审核不通过
      if (this.detailDialogData.status === '财务复核通过') {
        ...
        temp['reconno'] = this.duizhangdanNo
        if (this.chargeType === 1 || this.chargeType === '1' || IsEmpty(this.chargeType)) {
          api('/lifeCharge/lifeChargePoundageReconDelectRevamp', 'post', temp).then((res) => {
            console.log(res)
            this.closeLoading()
            if (res.data === '操作成功!') {
              this.openToast('success', res.data)
          ...
          api('/lifeCharge/newlifeChargePoundageReconDelectRevamp', 'post', temp).then((res) => {
            console.log(res)
            this.closeLoading()
            if (res.data === '操作成功!') {
              this.openToast('success', res.data)
    ...
    fuheNopass () { // 复核不通过
      if (this.detailDialogData.status === '财务复核通过') {
        ...
        temp['reconno'] = this.duizhangdanNo
        if (this.chargeType === 1 || this.chargeType === '1' || IsEmpty(this.chargeType)) {
          api('/lifeCharge/lifeChargePoundageReconDelect', 'post', temp).then((res) => {
            console.log(res)
            this.closeLoading()
            if (res.data === '操作成功!') {
              this.openToast('success', res.data)
          ...
          api('/lifeCharge/newlifeChargePoundageReconDelect', 'post', temp).then((res) => {
            console.log(res)
            this.closeLoading()
            if (res.data === '操作成功!') {
              this.openToast('success', res.data)
    ...
    kaipiaoOriginInfoExport () {
      // 原始开票信息导出
      window.open(`/tabycore/lifeCharge/downloadLifeChargeImportRecord?reconno=${this.duizhangdanNo}`)
    },
    ...
    kaipiaoInfoExport () {
      // 开票信息导出
      window.open(`/tabycore/lifeCharge/downloadLifeChargeInvoice?reconno=${this.duizhangdanNo}`)
    },
    errorInfoExport () {
      // 错误信息导出
      window.open(`/tabycore/lifeCharge/inportInvoiceError?reconno=${this.duizhangdanNo}`)
    },
    addDetailData () {
      // 数据从详情接口返回
      let temp = {
    ...
    childClose () {
      ...
      this.kaipInfo[this.nashuirenIndex].ratepayercomcode = ''
      this.kaipInfo[this.nashuirenIndex].ratepayername = ''
      this.kaipInfo[this.nashuirenIndex].ratepayeradd = ''
      this.kaipInfo[this.nashuirenIndex].ratepayerno = ''
      this.kaipInfo[this.nashuirenIndex].ratepayerphone = ''
      this.kaipInfo[this.nashuirenIndex].ratepayerbankname = ''
      this.kaipInfo[this.nashuirenIndex].ratepayerbankcode = ''
    ...
    changeData (row) {
      this.comDialog2 = false
      this.kaipInfo[this.nashuirenIndex].ratepayercomcode = row.ratepayercomcode
      this.kaipInfo[this.nashuirenIndex].ratepayername = row.ratepayername
      this.kaipInfo[this.nashuirenIndex].ratepayeradd = row.ratepayeradd
      this.kaipInfo[this.nashuirenIndex].ratepayercode = row.ratepayercode
      this.kaipInfo[this.nashuirenIndex].ratepayerno = row.ratepayerno
      this.kaipInfo[this.nashuirenIndex].ratepayerphone = row.ratepayerphone
      this.kaipInfo[this.nashuirenIndex].ratepayerbankname = row.ratepayerbankname
      this.kaipInfo[this.nashuirenIndex].ratepayerbankcode = row.ratepayerbankcode
    },
    changeData1 (row) {
      this.comDialog3 = false
...
// currentPage;//
// pageSize;//
          this.nashuirenInfo.ratepayercomcode = this.kaipInfo[index2].ratepayercomcode
          this.nashuirenInfo.ratepayername = this.kaipInfo[index2].ratepayername
          this.nashuirenInfo.ratepayeradd = this.kaipInfo[index2].ratepayeradd
          this.nashuirenInfo.ratepayerno = this.kaipInfo[index2].ratepayerno
          this.nashuirenInfo.ratepayerphone = this.kaipInfo[index2].ratepayerphone
    ...
    getDetailExamine (data) {
      if (data.verifyStatus === '审核通过') {
        if ((data.companyCode === '00007' || data.companyName === '天安人寿保险股份有限公司') && (data.comCode === 'BY0142' || data.comName === '天安佰盈保险销售有限公司吉林分公司')) {
          this.theTaxCom = false
        } else {
          this.theTaxCom = true
        }
        this.getDuizhangdanDetail(data)
      } else {
    ...
    getDuizhangdanDetail (data) { // 获取对账单详情
      this.Loading()
      this.chargeType = (typeof data === 'object' ? data.chargeType : this.chargeType)
      this.duizhangdanNo = (typeof data === 'object' ? data.batchNo : data)
      if (this.chargeType === 1 || this.chargeType === '1' || IsEmpty(this.chargeType)) {
        api('/lifeCharge/queryFinanceLifeChargePoundageRecon', 'post', `reconno=${this.duizhangdanNo}`).then((res) => {
          console.log(res)
          this.closeLoading()
          if (res.data.code !== '000000' && !IsEmpty(res.data.code)) {
            this.openToast('warning', res.data.msg)
            ...
            this.kaipiaoTableData1 = this.detailDialogData1.lifeChargeInvoice
            this.detailDialogVis = true
          }
        })
      } else {
        api('/lifeCharge/newqueryFinanceLifeChargePoundageRecon', 'post', `reconno=${this.duizhangdanNo}`).then((res) => {
          console.log(res)
          this.closeLoading()
          if (res.data.code !== '000000' && !IsEmpty(res.data.code)) {
            this.openToast('warning', res.data.msg)
    ...
    calHandCal (index, handCalIndex) { // 自动计算调整后税款和调整后价款，税率为0%或3%或6%
        ...
        case '0':
          switch (handCalIndex) {
            ...
            case 2:
              ...
              break
            case 3:
              this.kaipiaoInputData[index].priceCal3 = (Math.round(this.kaipiaoInputData[index].allhandCal3 * 100) / 100).toFixed(2)
              this.kaipiaoInputData[index].shuiCal3 = 0.00
              break
            case 4:
              this.kaipiaoInputData[index].priceCal4 = (Math.round(this.kaipiaoInputData[index].allhandCal4 * 100) / 100).toFixed(2)
              this.kaipiaoInputData[index].shuiCal4 = 0.00
              break
            case 5:
              this.kaipiaoInputData[index].priceCal5 = (Math.round(this.kaipiaoInputData[index].allhandCal5 * 100) / 100).toFixed(2)
              this.kaipiaoInputData[index].shuiCal5 = 0.00
              break
            case 6:
              this.kaipiaoInputData[index].priceCal6 = (Math.round(this.kaipiaoInputData[index].allhandCal6 * 100) / 100).toFixed(2)
              this.kaipiaoInputData[index].shuiCal6 = 0.00
              break
            case 7:
              this.kaipiaoInputData[index].priceCal7 = (Math.round(this.kaipiaoInputData[index].allhandCal7 * 100) / 100).toFixed(2)
              this.kaipiaoInputData[index].shuiCal7 = 0.00
              break
            case 8:
              this.kaipiaoInputData[index].priceCal8 = (Math.round(this.kaipiaoInputData[index].allhandCal8 * 100) / 100).toFixed(2)
              this.kaipiaoInputData[index].shuiCal8 = 0.00
              break
            default:
              break
          }
        ...
        case '3':
          switch (handCalIndex) {
            ...
            case 2:
              ...
              break
            case 3:
              this.kaipiaoInputData[index].priceCal3 = (Math.round(this.kaipiaoInputData[index].allhandCal3 * 100) / 103).toFixed(2)
              this.kaipiaoInputData[index].shuiCal3 = (this.kaipiaoInputData[index].allhandCal3 - this.kaipiaoInputData[index].priceCal3).toFixed(2)
              break
            case 4:
              this.kaipiaoInputData[index].priceCal4 = (Math.round(this.kaipiaoInputData[index].allhandCal4 * 100) / 103).toFixed(2)
              this.kaipiaoInputData[index].shuiCal4 = (this.kaipiaoInputData[index].allhandCal4 - this.kaipiaoInputData[index].priceCal4).toFixed(2)
              break
            case 5:
              this.kaipiaoInputData[index].priceCal5 = (Math.round(this.kaipiaoInputData[index].allhandCal5 * 100) / 103).toFixed(2)
              this.kaipiaoInputData[index].shuiCal5 = (this.kaipiaoInputData[index].allhandCal5 - this.kaipiaoInputData[index].priceCal5).toFixed(2)
              break
            case 6:
              this.kaipiaoInputData[index].priceCal6 = (Math.round(this.kaipiaoInputData[index].allhandCal6 * 100) / 103).toFixed(2)
              this.kaipiaoInputData[index].shuiCal6 = (this.kaipiaoInputData[index].allhandCal6 - this.kaipiaoInputData[index].priceCal6).toFixed(2)
              break
            case 7:
              this.kaipiaoInputData[index].priceCal7 = (Math.round(this.kaipiaoInputData[index].allhandCal7 * 100) / 103).toFixed(2)
              this.kaipiaoInputData[index].shuiCal7 = (this.kaipiaoInputData[index].allhandCal7 - this.kaipiaoInputData[index].priceCal7).toFixed(2)
              break
            case 8:
              this.kaipiaoInputData[index].priceCal8 = (Math.round(this.kaipiaoInputData[index].allhandCal8 * 100) / 103).toFixed(2)
              this.kaipiaoInputData[index].shuiCal8 = (this.kaipiaoInputData[index].allhandCal8 - this.kaipiaoInputData[index].priceCal8).toFixed(2)
              break
            default:
              break
          }
        ...
        case '6':
          switch (handCalIndex) {
            ...
            case 2:
              ...
              break
            case 3:
              this.kaipiaoInputData[index].priceCal3 = (Math.round(this.kaipiaoInputData[index].allhandCal3 * 100) / 106).toFixed(2)
              this.kaipiaoInputData[index].shuiCal3 = (this.kaipiaoInputData[index].allhandCal3 - this.kaipiaoInputData[index].priceCal3).toFixed(2)
              break
            case 4:
              this.kaipiaoInputData[index].priceCal4 = (Math.round(this.kaipiaoInputData[index].allhandCal4 * 100) / 106).toFixed(2)
              this.kaipiaoInputData[index].shuiCal4 = (this.kaipiaoInputData[index].allhandCal4 - this.kaipiaoInputData[index].priceCal4).toFixed(2)
              break
            case 5:
              this.kaipiaoInputData[index].priceCal5 = (Math.round(this.kaipiaoInputData[index].allhandCal5 * 100) / 106).toFixed(2)
              this.kaipiaoInputData[index].shuiCal5 = (this.kaipiaoInputData[index].allhandCal5 - this.kaipiaoInputData[index].priceCal5).toFixed(2)
              break
            case 6:
              this.kaipiaoInputData[index].priceCal6 = (Math.round(this.kaipiaoInputData[index].allhandCal6 * 100) / 106).toFixed(2)
              this.kaipiaoInputData[index].shuiCal6 = (this.kaipiaoInputData[index].allhandCal6 - this.kaipiaoInputData[index].priceCal6).toFixed(2)
              break
            case 7:
              this.kaipiaoInputData[index].priceCal7 = (Math.round(this.kaipiaoInputData[index].allhandCal7 * 100) / 106).toFixed(2)
              this.kaipiaoInputData[index].shuiCal7 = (this.kaipiaoInputData[index].allhandCal7 - this.kaipiaoInputData[index].priceCal7).toFixed(2)
              break
            case 8:
              this.kaipiaoInputData[index].priceCal8 = (Math.round(this.kaipiaoInputData[index].allhandCal8 * 100) / 106).toFixed(2)
              this.kaipiaoInputData[index].shuiCal8 = (this.kaipiaoInputData[index].allhandCal8 - this.kaipiaoInputData[index].priceCal8).toFixed(2)
              break
            default:
              break
    ...
    examPriceCalBigger (index, index1) { // 每种票据类型的税款都必须小于价款
      switch (index1) {
        case 1:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal1)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal1))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        case 2:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal2)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal2))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        case 3:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal3)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal3))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        case 4:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal4)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal4))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        case 5:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal5)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal5))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        case 6:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal6)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal6))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        case 7:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal7)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal7))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        case 8:
          if (Math.abs(parseFloat(this.kaipiaoInputData[index].aftershuiCal8)) > Math.abs(parseFloat(this.kaipiaoInputData[index].afterpriceCal8))) {
            this.openToast('warning', '调整后的税款必须小于调整后的价款')
          }
          break
        default:
