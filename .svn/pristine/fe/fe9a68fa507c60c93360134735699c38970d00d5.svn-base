<template>
  <div id="billView" >
        ...
        <el-row class="ri-line">
          ...
          <el-form-item class="comCode" prop="comCode">
            <ui-label-text :required="true" labelWidth="180" label="佰盈机构代码：">
              <el-input v-model="info.comCode" ref="baiyingCodeText" slot="text" @input="baiyingchange(1)" @dblclick.native.prevent="dbQuery(1,'by')" @blur='opensingleComDialog(1)' placeholder="双击可选择" clearable></el-input>
            </ui-label-text>
          </el-form-item>
          </el-col>
          <el-col :span="12">
          <el-form-item class="comName" prop="comName">
            <ui-label-text :required="true" labelWidth="180" label="佰盈机构名称:">
              <el-input v-model="info.comName" ref="baiyingNameText" slot="text" @input="baiyingchange(2)" @dblclick.native.prevent="dbQuery(1,'by')" @blur='opensingleComDialog(1)' placeholder="双击可选择" clearable></el-input>
            </ui-label-text>
          </el-form-item>
          </el-col>
        </el-row>
        <el-row class="ri-line">
          <el-col :span="12">
            <ui-label-text labelWidth="180" label="保险公司代码：">
              <el-input v-model="info.companyCode" ref="baoxianCodeText" slot="text" @change="baoxianChange(1)" @dblclick.native="dbQueryCom(1,'com')" @blur='opensingleComDialog(0)' placeholder="双击可选择" clearable></el-input>
            </ui-label-text>
          </el-col>
          <el-col :span="12">
            <ui-label-text labelWidth="180" label="保险公司名称：">
              <el-input v-model="info.companyName" ref="baoxianNameText" slot="text" @change="baoxianChange(2)" @dblclick.native="dbQueryCom(1,'com')" @blur='opensingleComDialog(0)' placeholder="双击可选择" clearable></el-input>
            </ui-label-text>
          </el-col>
        </el-row>
        <el-row class="ri-line">
        ...
        <el-row class="ri-line">
          ...
          <el-form-item class="yearMouth" prop="yearMouth">
             <ui-label-text labelWidth="180" label="结算年月（轨迹查询专用）:" >
               <el-input v-model="info.yearMouth" slot="text" ></el-input>
            </ui-label-text>
          </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <el-table-column
              ...
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.paidpremiumTax }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="保费（不含增值税）"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.paidpremiumNotTax }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="应收手续费金额（含增值税）"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.poundageTax }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="应收手续费金额（不含增值税）"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.poundageNotTax }}</span>
              </template>
            </el-table-column>
          </el-table-column>
          <el-table-column
            ...
            <el-table-column
              ...
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.subpaidpremiumTax }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="保费（不含增值税）"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.subpaidpremiumNotTax }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="转代理手续费金额（含增值税）"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.subagentPoundage }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="应收手续费金额（含增值税）"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.subpoundageTax }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="应收手续费金额（不含增值税）"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.subpoundageNotTax }}</span>
              </template>
            </el-table-column>
          </el-table-column>
          <el-table-column
            label="合计应收手续费金额（含增值税）"
            width="180">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.sumpoundageTax }}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="合计应收手续费金额（不含增值税）"
            width="180">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.sumpoundageNotTax }}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="服务费（含增值税）"
            width="180">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.servPoundageTax }}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="服务费（不含增值税）"
            width="180">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.servPoundageNotTax }}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="对账合计金额（含增值税）"
            width="180">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.allPoundageTax }}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="对账合计金额（不含增值税）"
            width="180">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.allPoundageNotTax }}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="对账单生成日期"
      ...
      <!-- 双击弹框 -->
      <el-dialog :append-to-body="true" width="60%" title="佰盈机构" :visible.sync="dialogTableVisibleCode" :before-close="dialogOnclose">
      <el-table stripe ref="multipleTable" @row-click="handleRowChange" :data="dbcomData" tooltip-effect="dark" style="width: 100%">
    ...
    <el-dialog :append-to-body="true" width="60%" title="保险公司" :visible.sync="dialogTableVisibleCode1" :before-close="dialogOnclose1">
      <el-table stripe ref="multipleTable" @row-click="handleInsRowChange" :data="insComData" tooltip-effect="dark" style="width: 100%">
    ...
    <!-- 详情 -->
    <el-dialog :append-to-body="true" width="85%" title="" :visible.sync="dialogDetailVisibleCode">
      <ui-line-tittle :collapsible="true" >
        ...
        <div class="ri-content" slot="content" >
          ...
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="直接代理保费（含增值税）:" >
                <el-input v-model="billDetailData.paidpremiumTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="直接代理保费（不含增值税）:" >
                <el-input v-model="billDetailData.paidpremiumNotTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
          </el-row>
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="直接代理协议手续费金额（含增值税）:" >
                <el-input v-model="billDetailData.poundage" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="直接代理应收手续费金额（含增值税）：:" >
                <el-input v-model="billDetailData.poundageTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
          </el-row>
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="直接代理应收手续费金额（不含增值税）:" >
                <el-input v-model="billDetailData.poundageNotTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <!-- <el-col :span="12">
              <ui-label-text labelWidth="120" label="收款日期:" >
                <el-input v-model="billDetailData.insurerName" slot="text"></el-input>
              </ui-label-text>
            </el-col> -->
          </el-row>
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="转代理保费（含增值税）:" >
                <el-input v-model="billDetailData.subpaidpremiumTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="转代理保费（不含增值税）:" >
                <el-input v-model="billDetailData.subpaidpremiumNotTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
          </el-row>
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="转代理手续费金额（含增值税）:" >
                <el-input v-model="billDetailData.subagentPoundage" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="转代理应收手续费金额（含增值税）:" >
                <el-input v-model="billDetailData.subpoundageTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
          </el-row>
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="转代理应收手续费金额（不含增值税）:" >
                <el-input v-model="billDetailData.subpoundageNotTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <!-- <el-col :span="12">
              <ui-label-text labelWidth="120" label="转代理应收手续费金额（不含增值税）:" >
          ...
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="合计应收手续费金额（含增值税）:" >
                <el-input v-model="billDetailData.sumpoundageTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="合计应收手续费金额（不含增值税）:" >
                <el-input v-model="billDetailData.sumpoundageNotTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
          </el-row>
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="服务费（含增值税）:" >
                <el-input v-model="billDetailData.servPoundageTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="服务费（不含增值税）:" >
                <el-input v-model="billDetailData.servPoundageNotTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
          </el-row>
          <el-row class="ri-line">
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="对账合计金额（含增值税）:" >
                <el-input v-model="billDetailData.allPoundageTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
            <el-col :span="12">
              <ui-label-text labelWidth="120" label="对账合计金额（不含增值税）:" >
                <el-input v-model="billDetailData.allPoundageNotTax" slot="text"></el-input>
              </ui-label-text>
            </el-col>
          </el-row>
        </div>
      ...
      <ui-line-tittle :collapsible="true" >
        ...
        <div class="ri-content" slot="content" >
          <el-table stripe ref="multipleTable" :data="DialogTableShowData" tooltip-effect="dark" style="width: 100%">
            <el-table-column
              label="佰盈机构代码"
              width="180">
              <template slot-scope="scope">
            ...
            <el-table-column
              ...
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.comcomcode }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="佰盈三级机构名称"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.comcomname }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="业务员代码"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.handlercode }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="业务员名称"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.handlername }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="保单号"
            ...
            <el-table-column
              ...
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.risktype }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="险种类型名称"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.riskflag }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="签单日期"
            ...
            <el-table-column
              ...
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insurancestart }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="保单止期"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuranceend }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="投保人姓名"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insureman }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="投保人证件类型"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuremantype }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="投保人证件号码"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuremanno }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="投保人联系方式"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuremanapp }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="被保险人姓名"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuredman }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="被保险人证件类型"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuredmantype }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="被保险人证件号码"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuredmanno }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="被保险人证件类型"
            ...
            <el-table-column
              ...
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.insuredmanapp }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="直接代理/转代理"
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.agency }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="保费（含增值税）"
            ...
            <el-table-column
              ...
              width="180">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.subagentrate }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="转代理手续费金额（含增值税）"
...
export default {
  ...
  mounted () {
    api(`/auth/findButtonByUserCodeAndPage?userId=${this.$store.state.login.loginUserId}&page=产险运营部审核`, 'get').then(result => {
      console.log(result)
  ...
  methods: {
    ...
    dbQueryCom (flag) {
      if (flag === 1) {
        ...
        this.companyQueryInfo.pageSize = 10
      } else {
    ...
    getHandleQuery () {
      ...
      this.$refs['queryForm'].validate((valid) => {
        if (valid) {
          ...
          this.queryMoneyBillView(temp).then(
            () => {
              this.closeLoading()
            }
          )
    ...
    handleExport () {
      this.$refs['queryForm'].validate((valid) => {
        if (valid) {
          ...
          window.open('/tabycore/propertyCharge/downloadPropertyChargePoundageRecons?companyCode=' + expData.companyCode + '&companyName=' + expData.companyName + '&comCode=' + expData.comCode + '&comName=' + expData.comName + '&verifyStatus=' + expData.verifyStatus + '&startDate=' + expData.startDate + '&endDate=' + expData.endDate + '&status=' + expData.status + '&batch=' + expData.batch)
      ...
      if (IsEmpty(this.info.companyCode)) {
        ...
        this.$refs['queryForm'].validate((valid) => {
          if (valid) {
            ...
            temp.yearMouth = this.info.yearMouth
            this.Loading()
            this.queryMoneyTrack(temp).then(
              () => {
                this.closeLoading()
    ...
    handleDetail (row) {
      ...
      console.log(row)
      this.getMoneyBillDetail(row.batchNo).then(
        () => {
          this.closeLoading()
          this.dialogDetailVisibleCode = true
          this.DialogTableAllData = this.$store.state.billView.billMoneyDetailData.propertyChargeCompareDetail
    ...
    check () {
      if (IsEmpty(this.checkInfo.status)) {
        ...
        if (this.checkInfo.status !== 2 && this.checkInfo.status !== 9) {
          ...
          this.Loading()
          this.checkMoneyBillView(this.checkInfo).then(
            (res) => {
              this.closeLoading()
              this.isCheckDialogShow = false
              if (res.data === '操作成功!') {
  ...
  computed: {
    ...
    billQueryData  () {
      return this.$store.state.billView.billMoneyQueryData
    },
    msg () {
      return this.$store.state.billView.moneymsg
    },
    totalRecords () {
      return parseInt(this.$store.state.billView.billMoneyTotalRecords)
    },
    insComData () {
    ...
    billDetailData () {
      let temp = this.$store.state.billView.billMoneyDetailData
    ...
    dbcomData () {
      console.log(this.$store.state.billView.comData)
      if (IsEmpty(this.$store.state.billView.comData)) {
        return []
      } else {
    ...
    dbcomTotal () {
      return parseInt(this.$store.state.billView.totalCom)
    }
  }
}
</script>
