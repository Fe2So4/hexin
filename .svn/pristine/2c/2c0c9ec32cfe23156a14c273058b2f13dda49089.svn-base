  ...
  <div id="lifeInsListImp" >
    <ui-notice-bar slot="breadcast" >
      <el-breadcrumb slot="location" separator=">">
        ...
        <el-breadcrumb-item>寿险首期承保清单</el-breadcrumb-item>
      </el-breadcrumb>
    </ui-notice-bar>
    <el-form class="mesg_form" :model="info" ref="info" :rules="rule" style="margin-top: 20px; ">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item >
            <ui-label-text labelWidth="150" label="结佣月：">
              <el-date-picker slot="text" type="date" placeholder="请选择" v-model="info.commDate" value-format="yyyy-MM" format="yyyy-MM">
              </el-date-picker>
            </ui-label-text>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item>
            <ui-label-text labelWidth="150" label="渠道:" >
              <el-select  slot="text" v-model="info.agentType" placeholder="请选择">
        ...
        <el-col :span="12">
          <el-form-item prop="time">
            <ui-label-text :required="true" labelWidth="150" label="保单承保日期：">
              <el-date-picker slot="text" unlink-panels style="width: 56%;" v-model="info.time" type="daterange" value-format="yyyy-MM-dd" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
              </el-date-picker>
            </ui-label-text>
          </el-form-item>
        </el-col>
    ...
    <div class="rate-table" v-show="isTableShow">
      <el-table stripe :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="createTime" label="保单回录日期" width="120" ></el-table-column>
        <el-table-column prop="proDate" label="投保日期" width="120" ></el-table-column>
        ...
        <el-table-column prop="receipSignDate" label="回执签收日期" width="120" ></el-table-column>
        <el-table-column prop="receiptDueDate" label="回执到期日期" width="120" ></el-table-column>
        <el-table-column prop="paulHesitatedDate" label="犹豫期撤保日期" width="120" ></el-table-column>
        <el-table-column prop="statePolicy" label="保单状态" width="120" ></el-table-column>
        ...
        <el-table-column prop="subCompanyCode" label="省级分公司代码" width="120" ></el-table-column>
        <el-table-column prop="subCompanyName" label="省级分公司名称" width="120" ></el-table-column>
        <el-table-column prop="municipalBranchesCode" label="地市级分公司代码" width="150" ></el-table-column>
        <el-table-column prop="municipalBranchesName" label="地市级分公司名称" width="150" ></el-table-column>
        <el-table-column prop="proLifeInsuranceCompanies" label="产品所属寿险公司" width="200" ></el-table-column>
        <el-table-column prop="kindCode" label="险种代码" width="200" ></el-table-column>
        <el-table-column prop="kindName" label="险种名称" width="200" ></el-table-column>
        <el-table-column prop="name" label="投保人姓名" width="120" ></el-table-column>
        ...
        <el-table-column prop="yearGuarantee" label="保障年期" width="120" ></el-table-column>
        <el-table-column prop="insured" label="保额" width="120" ></el-table-column>
        ...
        <el-table-column prop="primaryInsurance" label="主险/附加险" width="120" ></el-table-column>
        <el-table-column prop="agentCode" label="业务员姓名" width="120" ></el-table-column>
        <el-table-column prop="agentName" label="业务员代码" width="120" ></el-table-column>
        <el-table-column prop="businessNature" label="渠道" width="120" ></el-table-column>
        <el-table-column prop="municipalBranchesCode" label="归属机构代码" width="120" ></el-table-column>
        <el-table-column prop="municipalBranchesName" label="归属机构名称" width="120" ></el-table-column>
        ...
        <el-table-column prop="classMidName" label="险种中类" width="120" ></el-table-column>
        <el-table-column prop="classSamllName" label="险种小类" width="120" ></el-table-column>
        <el-table-column prop="commDate" label="结佣月" width="120" ></el-table-column>
        <el-table-column prop="normalSettlementDate" label="结算月" width="120" ></el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    ...
    queryList (data) {
      this.Loading()
      this.queryReport(data).then(resp => {
        this.closeLoading()
        if (resp.code === '000000') {
    ...
    onexport () {
      this.$refs['info'].validate((valid) => {
        if (valid) {
          this.info.startDate = this.info.time[0]
          this.info.endDate = this.info.time[1]
          window.open(`/tabycore/lifeAcceptInsurance/exportReport8?iOrgCode=${this.info.iOrgCode}&iOrgName=${this.info.iOrgName}&insurerCode=${this.info.insurerCode}&insurerName=${this.info.insurerName}&period=${this.info.period}&currentPage=1&pageSize=9999&startDate=${this.info.startDate}&endDate=${this.info.endDate}&commDate=${this.info.commDate}&agentType=${this.info.agentType}`)
        } else {
          return false
        }
      })
    ...
    getAllProCom (page, tag, event) { // 获取公司
      ...
      this.getAllComP(postData).then(resp => {
    ...
    getAllCityCom (page, tag, event) { // 获取地市级公司
      ...
      this.getAllComC(postData).then(resp => {
        if (resp.code === '000000' || resp.code === '000002') {
          if (resp.code === '000002') {
            this.searchComTableData = []
          } else {
    ...
    getAllInsCom (page) { // 获取保险公司
      ...
      this.getAllInsCom_rate(postData).then(resp => {
        if (resp.code === '000000' || resp.code === '000002') {
          if (resp.code === '000002') {
